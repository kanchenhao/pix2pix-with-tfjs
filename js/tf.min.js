...
! function (e, t) {
  ...
  function inferShape(e) {
    ...
    return e instanceof Array && deepAssertShapeConsistency(e, r, []), r
  }
  ...
  function deepAssertShapeConsistency(e, t, r) {
    if (r = r || [], e instanceof Array) {
      ...
      for (var n = t.slice(1), a = 0; a < e.length; ++a) deepAssertShapeConsistency(e[a], n, r.concat(a))
  ...
  function copyTypedArray(e, t, r) {
    ...
    if ("bool" === t) {
      for (var n = new Uint8Array(e.length), a = 0; a < n.length; ++a) 0 !== Math.round(e[a]) && (n[a] = 1);
      return n
    }
    ...
    Profiler = function () {
      ...
      return e.prototype.profileKernel = function (e, t) {
        ...
        return (Array.isArray(r) ? r : [r]).forEach(function (t) {
          var r = t.dataSync();
          checkComputationForNaN(r, t.dtype, e), a.then(function (a) {
            n.logger.logKernelProfile(e, t, r, a.kernelMs)
          })
        }), r
      }, e
    }(),
  ...
  function getFilteredNodesXToY(e, t, r) {
    ...
    for (o = e.length - 1; o >= 0; o--) {
      i = (m = e[o]).inputs;
      var h = [];
      for (h.push(m.output), p = 0; p < h.length; p++)
        if (c[h[p].id]) {
          for (var s in i) c[i[s].id] = !0, d[m.id] = !0;
          break
        }
    }
    var f = [];
  ...
  function tensorToString(e, t, r, n) {
    var a = computeStrides(t),
      o = computeMaxSizePerColumn(e, t, a),
      i = t.length,
      s = subTensorToString(e, t, a, o),
      u = ["Tensor"];
  ...
  function computeMaxSizePerColumn(e, t, r) {
    var n = sizeFromShape(t),
      a = r[r.length - 1],
      o = new Array(a).fill(0);
    if (t.length > 1)
      for (var i = 0; i < n / a; i++)
        for (var s = i * a, u = 0; u < a; u++) o[u] = Math.max(o[u], valToString(e[s + u], 0).length);
    return o
  }
  ...
  function subTensorToString(e, t, r, n, a) {
    ...
    if (o > FORMAT_LIMIT_NUM_VALS) {
      for (var h = 0; h < FORMAT_NUM_FIRST_LAST_VALS; h++) {
        var f = (m = h * c) + c;
        d.push.apply(d, subTensorToString(e.subarray(m, f), l, p, n, !1))
      }
      for (d.push("..."), h = o - FORMAT_NUM_FIRST_LAST_VALS; h < o; h++) f = (m = h * c) + c, d.push.apply(d, subTensorToString(e.subarray(m, f), l, p, n, h === o - 1))
    } else
      for (h = 0; h < o; h++) {
        var m;
        f = (m = h * c) + c, d.push.apply(d, subTensorToString(e.subarray(m, f), l, p, n, h === o - 1))
      }
    var g = 2 === i ? "," : "";
  ...
  var Tensor = function () {
    ...
    return e.make = function (t, r, n) {
      ...
      return void 0 === r && (r = .001), this.throwIfDisposed(), opHandler.batchNormalization(this, e, t, r, n, a)
  ...
  var Variable = function (e) {
    function t(r, n, a) {
      void 0 === n && (n = !0);
      var o = e.call(this, r.shape, r.dtype, null, r.dataId) || this;
      o.trainable = n, o.name = a, null == o.name && (o.name = t.nextVarId.toString(), t.nextVarId++);
      try {
  ...
  var Type, Engine = function () {
      function e(e, t, r) {
        this.backend = e, this.safeMode = t, this.debugMode = r, this.registeredVariables = {}, this.refCounter = new WeakMap, this.nextTapeNodeId = 0, this.numBytes = 0, this.numTensors = 0, this.numDataBuffers = 0, this.gradientScopeCount = 0, this.customGradientDepth = 0, this.keepTensors = new Set, this.activeScope = {
          track: [],
          name: "default scope"
        }, this.scopeStack = [this.activeScope], this.profiler = new Profiler(e)
      }
      return e.prototype.tidy = function (e, t, r) {
        var n = this;
        void 0 === r && (r = !1);
        var a, o = null;
        if (null == t) {
        ...
        return assert(isFunction(e), "The f passed in customGrad(f) must be a function."),
          function () {
            for (var r, n, a = [], o = 0; o < arguments.length; o++) a[o] = arguments[o];
  ...
  e = Type || (Type = {}), e[e.NUMBER = 0] = "NUMBER", e[e.BOOLEAN = 1] = "BOOLEAN", e[e.STRING = 2] = "STRING";
  var URL_PROPERTIES = [{
    name: "DEBUG",
    type: Type.BOOLEAN
  }, {
  ...
  function isWebGLVersionEnabled(e, t) {
    ...
    return null != r && (loseContext(r), !0)
  }

  function getWebGLDisjointQueryTimerVersion(e, t) {
    if (0 === e) return 0;
    var r, n = getWebGLRenderingContext(e, t);
    return r = hasExtension(n, "EXT_disjoint_timer_query_webgl2") && 2 === e ? 2 : hasExtension(n, "EXT_disjoint_timer_query") ? 1 : 0, null != n && loseContext(n), r
  }

  function isRenderToFloatTextureEnabled(e, t) {
    if (0 === e) return !1;
    var r = getWebGLRenderingContext(e, t);
    if (1 === e) {
      if (!hasExtension(r, "OES_texture_float")) return !1
    } else if (!hasExtension(r, "EXT_color_buffer_float")) return !1;
    createFloatTextureAndBindToFramebuffer(r, e);
    var n = r.checkFramebufferStatus(r.FRAMEBUFFER) === r.FRAMEBUFFER_COMPLETE;
    return loseContext(r), n
  }
  ...
  function isDownloadFloatTextureEnabled(e, t) {
    ...
    createFloatTextureAndBindToFramebuffer(r, e), r.readPixels(0, 0, 1, 1, r.RGBA, r.FLOAT, new Float32Array(4));
    var n = r.getError() === r.NO_ERROR;
    return loseContext(r), n
  }
  ...
  function getWebGLRenderingContext(e, t) {
    ...
    return 1 === e ? r.getContext("webgl") || r.getContext("experimental-webgl") : r.getContext("webgl2")
  }
    ...
    Environment = function () {
      ...
      return e.setBackend = function (e, t) {
        ...
        if ("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION" === e) {
          ...
          return 0 === t ? 0 : t > 0 ? 0 : getWebGLDisjointQueryTimerVersion(t, this.get("IS_BROWSER"))
        }
        ...
        var r = this;
        void 0 === t && (t = !1), this.backendName = e, this.backend = this.findBackend(e), this.globalEngine = new Engine(this.backend, t, function () {
          return r.get("DEBUG")
        })
  ...
  function getReshaped(e, t, r, n) {
    void 0 === n && (n = !0);
    var a = [];
    if (n)(a = a.concat(t.slice(0))).push(e[0] / r), a = a.concat(e.slice(1));
    else {
      a = a.concat(e[0]);
  ...
  function getPermuted(e, t, r) {
    ...
    if (r) {
      n.push(t);
      for (var a = t + 1; a < e; ++a) a <= 2 * t ? (n.push(a), n.push(a - (t + 1))) : n.push(a)
    } else {
      var o = [],
        i = [];
  ...
  function getReshapedPermuted(e, t, r, n) {
    ...
    for (var o = 1; o < e.length; ++o) o <= t.length ? n ? a.push(t[o - 1] * e[o]) : a.push(e[o] / t[o - 1]) : a.push(e[o]);
    return a
  }
  ...
  function getSliceSize(e, t, r) {
    for (var n = e.slice(0, 1), a = 0; a < r; ++a) n.push(e[a + 1] - t[a][0] - t[a][1]);
    return n
  }
  ...
  function computeOutShape(e, t, r) {
    for (var n = [], a = e.length, o = 0; o < a; o++) o !== t ? n.push(e[o]) : n.push(r);
    return n
  }
  ...
  function convertToTensor(e, t, r, n) {
    ...
    var a = inferShape(e);
    return isTypedArray(e) || Array.isArray(e) || (e = [e]), Tensor.make(a, {
  ...
  function tensor(e, t, r) {
    if (void 0 === r && (r = "float32"), !isTypedArray(e) && !Array.isArray(e) && "number" != typeof e && "boolean" != typeof e) throw new Error("values passed to tensor(values) must be an array of numbers or booleans, or a TypedArray");
    var n = inferShape(e);
  ...
  function scalar(e, t) {
    if (void 0 === t && (t = "float32"), isTypedArray(e) || Array.isArray(e)) throw new Error("Error creating a new Scalar: value must be a primitive (number|boolean)");
    return tensor(e, [], t)
  }
  ...
  var DType, UpcastInt32AndMap, UpcastBoolAndMap, UpcastFloat32AndMap, onesLike = op({
      onesLike_: onesLike_
    }),
    zerosLike = op({
  ...
  function castTensor(e, t, r) {
    ...
    if ("bool" === t) return r.notEqual(e, scalar(0, e.dtype));
  ...
  function nonMaxSuppressionImpl(e, t, r, n, a) {
    for (var o = Array.from(t).map(function (e, t) {
      ...
      var u = o[s],
        ...
        p = u.boxIndex;
      if (l < a) break;
      for (var c = !1, d = i.length - 1; d >= 0; --d)
        if (intersectionOverUnion(e, p, i[d]) >= n) {
          c = !0;
          break
  ...
  function intersectionOverUnion(e, t, r) {
    ...
    var m = Math.max(o, l),
      ...
      y = Math.min(s, c),
      v = Math.min(u, d),
      b = Math.max(y - m, 0) * Math.max(v - g, 0);
    return b / (h + f - b)
  }
  ...
  function topkImpl(e, t, r, n, a) {
    for (var o = t[t.length - 1], i = [e.length / o, o], s = i[0], u = i[1], l = getTypedArrayFromDType(r, s * n), p = getTypedArrayFromDType("int32", s * n), c = 0; c < s; c++) {
      for (var d = c * u, h = e.subarray(d, d + u), f = [], m = 0; m < h.length; m++) f.push({
        value: h[m],
        index: m
      });
      f.sort(function (e, t) {
      ...
      var g = c * n,
        y = l.subarray(g, g + n),
        v = p.subarray(g, g + n);
      for (m = 0; m < n; m++) y[m] = f[m].value, v[m] = f[m].index
    }
    var b = t.slice();
    return b[b.length - 1] = n, [tensor(l, b, r), tensor(p, b, "int32")]
  }
  ...
  var BatchNormProgram = function (e, t, r, n, a, o) {
  ...
  var ConcatProgram = function (e, t) {
  ...
  function makeShader(e, t, r, n) {
    ...
    var o = e.map(function (e) {
      ...
      i = t.texShape,
      s = getOutputSamplingSnippet(t.logicalShape, i);
    return [SHADER_PREFIX, FLOAT_TEXTURE_SAMPLE_SNIPPET, FLOAT_TEXTURE_SETOUTPUT_SNIPPET, a, s, o, r].join("\n")
  }
  ...
  function getBroadcastOutputCoordsSampler(e, t, r, n) {
    ...
    return "\n    float " + n + "() {\n      " + i + " coords = getOutputCoords();\n      " + (0 === a ? "" : o < 2 && s.length >= 1 ? "coords = 0;" : s.map(function (e) {
      return "coords[" + (e + u) + "] = 0;"
    }).join("\n")) + "\n      return get" + r + "(" + (o < 2 && a > 0 ? "coords" : e.shapeInfo.logicalShape.map(function (e, t) {
      return "coords[" + (t + u) + "]"
    }).join(", ")) + ");\n    }\n  "
  }
  ...
  function getSamplerAtOutputCoords(e, t, r) {
    var n = e.name,
      ...
      l = r && (u > s || i.length > 0),
      p = broadcastDimsAreOuter(i),
      c = e.shapeInfo.isUniform;
    if (l && !p) return getBroadcastOutputCoordsSampler(e, t, a, o);
    var d = sizeFromShape(e.shapeInfo.logicalShape),
      h = "";
    l && p && (h = "\n        int mainPart = index / " + d + ";\n        index -= mainPart * " + d + ";\n      ");
    var f = t.texShape;
    if (c) return 1 === d ? "float " + o + "() {return " + n + ";}" : "\n      float " + o + "() {\n        ivec2 resTexRC = ivec2(resultUV.yx *\n                              vec2(" + f[0] + ", " + f[1] + "));\n        int index = resTexRC.x * " + f[1] + " + resTexRC.y;\n        " + h + "\n        return get" + a + "Flat(index);\n      }\n    ";
  ...
  function encodeMatrixToPackedRGBA(e, t, r, n) {
    ...
    for (var o = getPackedMatrixTextureShapeWidthHeight(t, r), i = o[0], s = o[1], u = r % 2 == 1, l = t % 2 == 1, p = Math.floor(r / 2), c = Math.floor(t / 2), d = u ? 4 : 0, h = r, f = 0, m = 0; m < c; ++m) {
      for (var g = 2 * m * r, y = 0; y < p; ++y) {
        var v = g + 2 * y;
    ...
    if (u) {
      v = r - 1, f = 4 * (i - 1);
      var b = 2 * r;
      for (d = 4 * i, m = 0; m < c; ++m) n[f] = e[v], n[f + 2] = e[v + r], v += b, f += d
    }
    if (l)
      for (v = (t - 1) * r, f = (s - 1) * i * 4, y = 0; y < p; ++y) n[f++] = e[v++], n[f++] = e[v++], f += 2;
  ...
  function decodeMatrixFromPackedRGBA(e, t, r, n) {
    ...
    for (var o = r % 2 == 1, i = t % 2 == 1, s = Math.floor(r / 2), u = Math.floor(t / 2), l = getPackedMatrixTextureShapeWidthHeight(t, r), p = l[0], c = l[1], d = o ? 4 : 0, h = r + (o ? 1 : 0), f = 0, m = 0, g = r, y = 0; y < u; ++y) {
    ...
    if (o) {
      f = 4 * (p - 1);
      var b = r - 1;
      for (d = 4 * p, h = 2 * r, y = 0; y < u; ++y) n[b] = e[f], n[b + r] = e[f + 2], f += d, b += h
    }
    if (i)
      for (f = (c - 1) * p * 4, b = (t - 1) * r, v = 0; v < s; ++v) n[b++] = e[f++], n[b++] = e[f++], f += 2;
  ...
  function uploadMatrixToTexture(e, t, r, n, a, o, i) {
    var s, u = getUnpackedMatrixTextureShapeWidthHeight(r, n),
      l = u[0],
      p = u[1];
    1 === i.defaultNumChannels ? s = a : encodeMatrixToUnpackedArray(a, s = new Float32Array(getUnpackedArraySizeFromMatrixSize(a.length, o)), o), uploadDataToTexture(e, t, l, p, s, i.textureFormatFloat)
  }

  function uploadMatrixToPackedTexture(e, t, r, n, a, o) {
    var i = getPackedMatrixTextureShapeWidthHeight(r, n),
      s = i[0],
      u = i[1],
  ...
  function downloadFloat32MatrixFromBuffer(e, t, r, n, a) {
    ...
    o.bindBuffer(e.ARRAY_BUFFER, t), o.getBufferSubData(e.ARRAY_BUFFER, 0, i), o.bindBuffer(e.ARRAY_BUFFER, null);
  ...
  function compileProgram(e, t, r, n) {
    for (var a = t.userCode, o = r.map(function (e, r) {
        ...
        isUniform: !1
      }, u = makeShader(o, s, a, !0 === t.supportsBroadcasting), l = e.createProgram(u), p = {}, c = 0; c < t.variableNames.length; c++) {
      var d = t.variableNames[c];
      p[d] = e.getUniformLocation(l, d, !1)
    }
    return {
      program: t,
      source: u,
  ...
  function runProgram(e, t, r, n) {
    ...
    i.setOutputMatrixTexture(a, o[0], o[1]), i.setProgram(e.webGLProgram), t.forEach(function (t, r) {
      ...
      if (null != a) {
        if (t.isUniform) {
          if (1 === t.tensor.size) i.gl.uniform1f(a, t.tensor.dataSync()[0]);
          else {
            var o = t.tensor.dataSync();
            o instanceof Float32Array || (o = new Float32Array(o)), i.gl.uniform1fv(a, o)
          }
          return
        }
        var s = t.texData.texture;
        i.setInputMatrixTexture(s, a, r)
      }
  ...
  function makeShaderKey(e, t, r) {
    ...
    return e.constructor.name + "_" + o + "_" + n + "_" + a
  }
  var LRNProgram = function (e, t, r, n, a) {
    ...
    LRNGradProgram = function (e, t, r, n, a) {
    ...
    Pool2DProgram = function (e, t, r) {
      ...
      var l = "avg" === t,
        p = "0.0";
      if (l || (p = "-1.0 / 0.0"), r) this.userCode = "\n        const ivec2 strides = ivec2(" + o + ", " + i + ");\n        const ivec2 pads = ivec2(" + s + ", " + u + ");\n\n        void main() {\n          ivec4 coords = getOutputCoords();\n          int batch = coords[0];\n          int d = coords[3];\n\n          ivec2 xRCCorner = coords.yz * strides - pads;\n          int xRCorner = xRCCorner.x;\n          int xCCorner = xRCCorner.y;\n\n          // max/min x(?, ?, d) to get y(yR, yC, d).\n          // ? = to be determined\n          float minMaxValue = 0.0;\n          float minMaxValueFound = 0.0;\n          int minMaxPosition = 0;\n          float avgValue = 0.0;\n\n          for (int wR = 0; wR < " + n + "; wR++) {\n            int xR = xRCorner + wR;\n\n            if (xR < 0 || xR >= " + e.inHeight + ") {\n              continue;\n            }\n\n            for (int wC = 0; wC < " + a + "; wC++) {\n              int xC = xCCorner + wC;\n\n              if (xC < 0 || xC >= " + e.inWidth + ") {\n                continue;\n              }\n\n              float value = getX(batch, xR, xC, d);\n\n              // If a min / max value has already been found, use it. If not,\n              // use the current value.\n              float currMinMaxValue = mix(\n                  value, minMaxValue, minMaxValueFound);\n              if (value >= currMinMaxValue) {\n                minMaxValue = value;\n                minMaxValueFound = 1.0;\n                minMaxPosition = wR * " + a + " + wC;\n              }\n            }\n          }\n          setOutput(float(minMaxPosition));\n        }\n      ";
      else {
        var c = t + "(" + t + "(" + t + "(minMaxValue[0], minMaxValue[1]), minMaxValue[2]), minMaxValue[3])";
        "avg" === t && (c = "avgValue / count");
    ...
    ReduceProgram = function (e, t) {
      ...
      var i = "0.0",
        s = "";
      "min" === t ? (i = "1.0 / 0.0", s = "min") : "max" === t && (i = "-1.0 / 0.0", s = "max");
      var u = t + "(" + t + "(" + t + "(minMaxValue[0], minMaxValue[1]), minMaxValue[2]), minMaxValue[3])";
      "sum" === t ? u = "sumValue" : "all" === t ? u = "allValue" : "any" === t && (u = "anyValue");
    ...
    ResizeNearestNeigborBackpropProgram = function (e, t, r) {
      this.variableNames = ["dy"], this.outputShape = [], this.outputShape = t.shape;
      var n = t.shape,
        a = n[1],
        o = n[2],
  ...
  function concat_(e, t) {
    ...
    for (var a = parseAxisParam(t, n.shape), o = 1; o < r.length; ++o) n = concat2Tensors(n, r[o], a[0]);
    return n
  }

  function concat2Tensors(e, t, r) {
    assertParams(e.shape, t.shape, r);
    var n = computeOutShape$1(e.shape, t.shape, r),
  ...
  var alea = createCommonjsModule(function (e) {
      ! function (e, t, r) {
        ...
        function a(e, t) {
          ...
          }, o.quick = o, a && ("object" == typeof a && n(a, r), o.state = function () {
            return n(r, {})
          }), o
        }
      ...
      ! function (e, t, r) {
        ...
        function a(e, t) {
          ...
          return o.double = function () {
            ...
            return e
          }, o.int32 = r.next, o.quick = o, a && ("object" == typeof a && n(a, r), o.state = function () {
            return n(r, {})
          }), o
        }
    ...
    seedrandom = createCommonjsModule(function (e) {
      ! function (t, r) {
          ...
          var y = [],
            ...
            b = new function (e) {
              var t, r = e.length,
                ...
                s = n.S = [];
              for (r || (e = [r++]); a < o;) s[a] = a++;
              for (a = 0; a < o; a++) s[a] = s[i = c & i + e[a % r] + (t = s[a])], s[i] = t;
              (n.g = function (e) {
                for (var t, r = 0, a = n.i, i = n.j, s = n.S; e--;) t = s[a = c & a + 1], r = r * o + s[c & (s[a] = s[i = c & i + t]) + (s[i] = t)];
                return n.i = a, n.j = i, r
              })(o)
            }(y),
            x = function () {
              for (var e = b.g(i), t = u, r = 0; e < l;) e = (e + r) * o, t *= o, r = b.g(1);
              for (; e >= p;) e /= 2, t /= 2, r >>>= 1;
              return (e + r) / t
            };
        ...
        function f(e, t) {
          for (var r, n = e + "", a = 0; a < n.length;) t[c & a] = c & (r ^= 19 * t[c & a]) + n.charCodeAt(a++);
          return m(t)
        }
  ...
  function eye_(e, t, r, n) {
    ...
    for (var a = buffer([e, t], n), o = e <= t ? e : t, i = 0; i < o; ++i) a.set(1, i, i);
  ...
  function randomNormal_(e, t, r, n, a) {
    ...
    for (var o = new MPRandGauss(t, r, n, !1, a), i = buffer(e, n), s = 0; s < i.values.length; s++) i.values[s] = o.nextValue();
    return i.toTensor()
  }

  function truncatedNormal_(e, t, r, n, a) {
    if (void 0 === t && (t = 0), void 0 === r && (r = 1), null != n && "bool" === n) throw new Error("Unsupported data type " + n);
    for (var o = new MPRandGauss(t, r, n, !0, a), i = buffer(e, n), s = 0; s < i.values.length; s++) i.values[s] = o.nextValue();
    return i.toTensor()
  }

  function randomUniform_(e, t, r, n) {
    void 0 === t && (t = 0), void 0 === r && (r = 1), void 0 === n && (n = "float32");
    for (var a = buffer(e, n), o = 0; o < a.values.length; o++) a.values[o] = randUniform(t, r);
    return a.toTensor()
  }
  ...
  function oneHot_(e, t, r, n) {
    ...
    if (assert("int32" === a.dtype, "Indices must be of dtype `int32`"), t < 2) throw new Error("Error in oneHot: depth must be >=2, but it is " + t);
    return ENV.engine.runKernel(function (e) {
  ...
  function toPixels(e, t) {
    return __awaiter(this, void 0, void 0, function () {
      var r, n, a, o, i, s, u, l, p, c, d, h, f, m, g, y, v, b, x, w;
      return __generator(this, function (S) {
        switch (S.label) {
          ...
          case 2:
            if (p = S.sent()[0], s.dispose(), u.dispose(), "float32" === r.dtype) {
            ...
            return [4, r.data()];
          case 3:
            for (c = S.sent(), d = "float32" === r.dtype ? 255 : 1, h = new Uint8ClampedArray(o * a * 4), f = 0; f < a * o; ++f) m = void 0, g = void 0, y = void 0, v = void 0, 1 === i ? (m = c[f] * d, g = c[f] * d, y = c[f] * d, v = 255) : 3 === i ? (m = c[3 * f] * d, g = c[3 * f + 1] * d, y = c[3 * f + 2] * d, v = 255) : 4 === i && (m = c[4 * f] * d, g = c[4 * f + 1] * d, y = c[4 * f + 2] * d, v = c[4 * f + 3] * d), h[0 + (b = 4 * f)] = Math.round(m), h[b + 1] = Math.round(g), h[b + 2] = Math.round(y), h[b + 3] = Math.round(v);
            return null != t && (t.width = o, t.height = a, x = t.getContext("2d"), w = new ImageData(h, o, a), x.putImageData(w, 0, 0)), r !== e && r.dispose(), [2, h]
        }
      })
    })
  }
    ...
    return assert(r.rank === t.length, "Error in transpose: rank of input " + r.rank + " must match length of reps " + t + "."), ENV.engine.runKernel(function (e) {
      ...
      return {
        $x: function () {
          var n = zerosLike(r);
          if (1 === r.rank)
            for (var a = 0; a < t[0]; ++a) n = n.add(e.slice([a * r.shape[0]], [r.shape[0]]));
          else if (2 === r.rank)
            for (a = 0; a < t[0]; ++a)
              for (var o = 0; o < t[1]; ++o) n = n.add(e.slice([a * r.shape[0], o * r.shape[1]], [r.shape[0], r.shape[1]]));
          else if (3 === r.rank)
            for (a = 0; a < t[0]; ++a)
              for (o = 0; o < t[1]; ++o)
                for (var i = 0; i < t[2]; ++i) n = n.add(e.slice([a * r.shape[0], o * r.shape[1], i * r.shape[2]], [r.shape[0], r.shape[1], r.shape[2]]));
          else {
            if (4 !== r.rank) throw new Error("Gradient for tile operation is not implemented for rank-" + r.rank + " tensors yet.");
            for (a = 0; a < t[0]; ++a)
              for (o = 0; o < t[1]; ++o)
                for (i = 0; i < t[2]; ++i)
                  for (var s = 0; s < t[3]; ++s) n = n.add(e.slice([a * r.shape[0], o * r.shape[1], i * r.shape[2], s * r.shape[3]], [r.shape[0], r.shape[1], r.shape[2], r.shape[3]]))
          }
          return n
        }
      }
  ...
  function batchToSpaceND_(e, t, r) {
    ...
    return assert(n.rank >= 1 + t.length, "input rank should be > than [blockShape] but got " + n.rank), assert(r.length === t.length, "crops.shape[0] must be equal to [blockShape] but got " + r.length), assert(n.shape[0] % a == 0, "input tensor batch must be divisible by prod( blockShape )"), ENV.engine.runKernel(function (e) {
  ...
  function spaceToBatchND_(e, t, r) {
    ...
    return assert(n.rank >= 1 + t.length, "input rank should be > than [blockShape] but got " + n.rank), assert(r.length === t.length, "paddings.shape[0] must be equal to [blockShape], got " + r.length), assert(n.shape.reduce(function (e, r, n) {
      return n > 0 && n <= t.length ? e && r % t[n - 1] == 0 : e
    }, !0), "input spatial dimensions must be divisible by blockShapes"), ENV.engine.runKernel(function (e) {
  ...
  function unstack_(e, t) {
    void 0 === t && (t = 0);
    for (var r, n = convertToTensor(e, "x", "unstack"), a = n.shape[t], o = Array(n.rank - 1).fill(0), i = 0, s = 0; s < n.rank; s++) s !== t && (o[i] = n.shape[s], i++);
    r = Array(a).fill(1);
    ...
    return r.map(function (e) {
      l[t] = e;
      var r = n.slice(u, l);
      return u[t] += e, r.reshape(o)
    })
  }

  function split_(e, t, r) {
    void 0 === r && (r = 0);
    var n, a = convertToTensor(e, "x", "split");
    r = parseAxisParam(r, a.shape)[0], "number" == typeof t ? (assert(a.shape[r] % t == 0, "Number of splits must evenly divide the axis."), n = Array(t).fill(a.shape[r] / t)) : (assert(a.shape[r] === t.reduce(function (e, t) {
      return e + t
    }), "The sum of sizes must match the size of the axis dimension."), n = t);
    var o = Array(a.rank).fill(0),
      i = a.shape.slice();
    ...
    MathBackendWebGL = function () {
      ...
      return e.prototype.register = function (e, t, r) {
        ...
        var r = this.texData.get(e),
          ...
          a = r.texShape,
          o = r.usage;
        null != n && (this.releaseTexture(e, n, a, o), r.texture = null, r.texShape = null), r.usage = TextureUsage.UPLOAD, r.values = t, this.delayedStorage || this.uploadToGPU(e)
      }, e.prototype.readSync = function (e) {
        this.throwIfNoData(e);
        ...
        u && (s = performance.now());
        var l = this.getValuesFromTexture(n, e, i, o, r);
        return u && (this.downloadWaitMs += performance.now() - s), this.cacheOnCPU(e, l), t.values
      }, e.prototype.read = function (e) {
        return __awaiter(this, void 0, void 0, function () {
          var t, r, n, a, o, i, s, u, l, p;
          return __generator(this, function (c) {
            switch (c.label) {
              case 0:
                ...
                if (this.throwIfNoData(e), r = this.texData.get(e), n = r.shape, a = r.texture, o = r.values, i = r.texShape, s = r.dtype, null != o) return this.cacheOnCPU(e), [2, o];
                ...
                return u = this.gpgpu.maybeCreateBufferFromTexture(a, i[0], i[1]), [4, this.gpgpu.createAndWaitForFence()];
              case 1:
                return c.sent(), l = u instanceof WebGLTexture ? this.getValuesFromTexture(a, e, s, i, n) : this.gpgpu.downloadFloat32MatrixFromBuffer(u, i[0], i[1]), this.cacheOnCPU(e, l), p = this.pendingRead.get(e), this.pendingRead.delete(e), p.forEach(function (e) {
                  return e(l)
                }), this.pendingDisposal.has(e) && (this.pendingDisposal.delete(e), this.disposeData(e)), [2, l]
            }
          })
        })
      }, e.prototype.getValuesFromTexture = function (e, t, r, n, a) {
        if (ENV.get("WEBGL_DOWNLOAD_FLOAT_ENABLED")) return this.gpgpu.downloadFloat32MatrixFromOutputTexture(e, n[0], n[1]);
        var o = Tensor.make(a, {});
        this.texData.get(o.dataId).usage = TextureUsage.DOWNLOAD;
        var i = Tensor.make(a, {
            dataId: t
          }, r),
          s = new EncodeFloatProgram(a);
        this.compileAndRun(s, [i], o, null, !1);
        var u = this.texData.get(o.dataId),
          l = this.gpgpu.downloadByteEncodedFloatMatrixFromOutputTexture(u.texture, u.texShape[0], u.texShape[1]);
        return i.dispose(), o.dispose(), l
      }, e.prototype.time = function (e) {
        return __awaiter(this, void 0, void 0, function () {
          var t, r, n, a, o, i;
          return __generator(this, function (s) {
        ...
        a.push.apply(a, r);
        for (var o = 1 + t.length; o < e.shape.length; ++o) a.push([0, 0]);
        var i = e.pad(a),
        ...
        var i = computeOutShape(o.shape, n, r),
        ...
        var o = e.shape[0],
          ...
          p = l[0],
          c = l[1],
          d = this.makeOutputArray([p, c], n);
        return this.compileAndRun(u, [e, r], d), d.shape[1] === a ? d : (r = range(0, a).tile([i / s]), this.segOpCompute(d, t, r, n, a))
        ...
        var r = new BinaryOpProgram(POW, e.shape, t.shape),
          n = r.getCustomSetupFunc(),
          a = this.makeOutputArray(r.outputShape, upcastType(e.dtype, t.dtype));
        return this.compileAndRun(r, [e, t], a, n)
        ...
        var o = this;
        void 0 === a && (a = !0), null == r && (r = this.makeOutputArray(e.outputShape, t[0].dtype));
        var i = t.map(function (e) {
          var t = o.texData.get(e.dataId);
          return null == t.texture && e.size <= SIZE_UPLOAD_UNIFORM ? {
            tensor: e,
            texData: null,
            isUniform: !0
          } : (o.uploadToGPU(e.dataId), {
            tensor: e,
            texData: t,
            isUniform: !1
          })
        ...
        if (c && (s = this.startTimer()), runProgram(p, i, u, n), a && this.numBytesInGPU > this.NUM_BYTES_BEFORE_PAGING)
          for (var d = this.numBytesInGPU - this.NUM_BYTES_BEFORE_PAGING; d > 0 && this.lruDataGPU.length > 0;) {
        ...
        return c && (s = this.endTimer(s), this.activeTimers.push(this.getQueryTime(s))), r
        ...
        if (null == a) {
          ...
          t.texShape = l;
          var p = this.acquireTexture(e, l, i);
          t.texture = p, null != n && (this.gpgpu.uploadMatrixToTexture(p, l[0], l[1], typedArrayToFloat32(n, o)), t.values = null, u && (this.uploadWaitMs += performance.now() - s))
        } else this.lruDataGPU.indexOf(e) >= 0 && (this.lruDataGPU.splice(this.lruDataGPU.indexOf(e), 1), this.lruDataGPU.push(e))
  ...
  function batchNormalization2d_(e, t, r, n, a, o) {
    ...
    return null != a && (i = convertToTensor(a, "scale", "batchNormalization")), null != o && (s = convertToTensor(o, "offset", "batchNormalization")), assert(2 === u.rank, "Error in batchNormalization3D: x must be rank 3 but got rank " + u.rank + "."), assert(2 === l.rank || 1 === l.rank, "Error in batchNormalization2D: mean must be rank 2 or rank 1 but got rank " + l.rank + "."), assert(2 === p.rank || 1 === p.rank, "Error in batchNormalization2D: variance must be rank 2 or rank 1 but got rank " + p.rank + "."), null != i && assert(2 === i.rank || 1 === i.rank, "Error in batchNormalization2D: scale must be rank 2 or rank 1 but got rank " + i.rank + "."), null != s && assert(2 === s.rank || 1 === s.rank, "Error in batchNormalization2D: offset must be rank 2 or rank 1 but got rank " + s.rank + "."), batchNormalization(u, l, p, n, i, s)
  }
  ...
  function batchNormalization3d_(e, t, r, n, a, o) {
    ...
    var i, s, u = convertToTensor(e, "x", "batchNormalization"),
      l = convertToTensor(t, "mean", "batchNormalization"),
      p = convertToTensor(r, "variance", "batchNormalization");
    return null != a && (i = convertToTensor(a, "scale", "batchNormalization")), null != o && (s = convertToTensor(o, "offset", "batchNormalization")), assert(3 === u.rank, "Error in batchNormalization3D: x must be rank 3 but got rank " + u.rank + "."), assert(3 === l.rank || 1 === l.rank, "Error in batchNormalization3D: mean must be rank 3 or rank 1 but got rank " + l.rank + "."), assert(3 === p.rank || 1 === p.rank, "Error in batchNormalization3D: variance must be rank 3 or rank 1 but got rank " + p.rank + "."), null != i && assert(3 === i.rank || 1 === i.rank, "Error in batchNormalization3D: scale must be rank 3 or rank 1 but got rank " + i.rank + "."), null != s && assert(3 === s.rank || 1 === s.rank, "Error in batchNormalization3D: offset must be rank 3 or rank 1 but got rank " + s.rank + "."), batchNormalization(u, l, p, n, i, s)
  }
  ...
  function batchNormalization4d_(e, t, r, n, a, o) {
    ...
    var i, s, u = convertToTensor(e, "x", "batchNormalization"),
      l = convertToTensor(t, "mean", "batchNormalization"),
      p = convertToTensor(r, "variance", "batchNormalization");
    return null != a && (i = convertToTensor(a, "scale", "batchNormalization")), null != o && (s = convertToTensor(o, "offset", "batchNormalization")), assert(4 === u.rank, "Error in batchNormalization4D: x must be rank 4 but got rank " + u.rank + "."), assert(4 === l.rank || 1 === l.rank, "Error in batchNormalization4D: mean must be rank 4 or rank 1 but got rank " + l.rank + "."), assert(4 === p.rank || 1 === p.rank, "Error in batchNormalization4D: variance must be rank 4 or rank 1 but got rank " + p.rank + "."), null != i && assert(4 === i.rank || 1 === i.rank, "Error in batchNormalization4D: scale must be rank 4 or rank 1 but got rank " + i.rank + "."), null != s && assert(4 === s.rank || 1 === s.rank, "Error in batchNormalization4D: offset must be rank 4 or rank 1 but got rank " + s.rank + "."), batchNormalization(u, l, p, n, i, s)
  }

  function batchNormalization_(e, t, r, n, a, o) {
    void 0 === n && (n = .001);
    var i, s, u, l = convertToTensor(e, "x", "batchNormalization"),
      p = convertToTensor(t, "mean", "batchNormalization"),
      c = convertToTensor(r, "variance", "batchNormalization");
    return null != a && (i = convertToTensor(a, "scale", "batchNormalization")), null != o && (s = convertToTensor(o, "offset", "batchNormalization")), assert(p.rank === c.rank, "Batch normalization gradient requires mean and variance to have equal ranks."), assert(null == s || p.rank === s.rank, "Batch normalization gradient requires mean and offset to have equal ranks."), assert(null == i || p.rank === i.rank, "Batch normalization gradient requires mean and scale to have equal ranks."), u = 0 === l.rank || 1 === l.rank ? l.as4D(1, 1, 1, l.size) : 2 === l.rank ? l.as4D(1, 1, l.shape[0], l.shape[1]) : 3 === l.rank ? l.as4D(1, l.shape[0], l.shape[1], l.shape[2]) : l, ENV.engine.runKernel(function (e) {
      return e.batchNormalization(u, batchnormReshape4D(p), batchnormReshape4D(c), n, batchnormReshape4D(i), batchnormReshape4D(s))
    }, {
      $x: l,
      $mean: p,
      $variance: c,
      ...
      var t = null == i ? scalar(1) : i,
        ...
        a = [];
      if (1 === p.rank) {
        for (var o = 0; o < u.shape.length - 1; ++o) a.push(u.shape[o]);
        a.push(1)
      }
      var s = l.sub(p),
        d = e.mul(t),
        h = rsqrt(c.add(scalar(n))),
        f = h.mul(h).mul(h).mul(scalar(-.5));
      return {
        $x: function () {
          return 1 === p.rank ? e.mul(tile(h.as4D(1, 1, 1, p.shape[0]), a)).mul(t).reshape(l.shape) : e.mul(h).mul(t).reshape(l.shape)
        },
        $mean: function () {
  ...
  function computeConv2DInfo(e, t, r, n, a, o, i, s) {
    ...
    var u = [-1, -1, -1, -1],
      ...
      c = u[2],
      d = u[3];
    if ("channelsLast" === s) l = e[0], p = e[1], c = e[2], d = e[3];
    else {
      if ("channelsFirst" !== s) throw new Error("Unknown dataFormat " + s);
      l = e[0], d = e[1], p = e[2], c = e[3]
    }
    var h, f = t[0],
      m = t[1],
      g = t[3],
      ...
      w = x[0],
      S = x[1],
      N = getPadAndOutInfo(a, p, c, v, b, getEffectiveFilterSize(f, w), getEffectiveFilterSize(m, S), o),
      T = N.padInfo,
      E = N.outHeight,
      I = N.outWidth,
      A = i ? g * d : g;
    return "channelsFirst" === s ? h = [l, A, E, I] : "channelsLast" === s && (h = [l, E, I, A]), {
      batchSize: l,
      dataFormat: s,
      inHeight: p,
      inWidth: c,
  ...
  function conv1d_(e, t, r, n, a, o, i) {
    ...
    var c = u.as4D(1, u.shape[0], u.shape[1], u.shape[2]),
      ...
      h = conv2d(d, c, [1, r], n, "NHWC", [1, o], i);
    return p ? h.as2D(h.shape[2], h.shape[3]) : h.as3D(h.shape[0], h.shape[2], h.shape[3])
  }
  ...
  function conv2d_(e, t, r, n, a, o, i) {
    ...
    var c = computeConv2DInfo(l.shape, u.shape, r, o, n, i),
      d = ENV.engine.runKernel(function (e) {
        return e.conv2d(l, u, c)
      }, {
        x: l,
        $filter: u
      }, function (e) {
  ...
  function matMul_(e, t, r, n) {
    ...
    var a = convertToTensor(e, "a", "matMul"),
      o = convertToTensor(t, "b", "matMul"),
      i = r ? a.shape[0] : a.shape[1],
      s = n ? o.shape[1] : o.shape[0];
    return assert(2 === a.rank && 2 === o.rank, "Error in matMul: inputs must be rank 2, got ranks " + a.rank + " and " + o.rank + "."), assert(i === s, "Error in matMul: inner shapes (" + i + ") and (" + s + ") of Tensors with shapes " + a.shape + " and " + o.shape + " and transposeA=" + r + " and transposeB=" + n + " must match."), ENV.engine.runKernel(function (e) {
      return e.matMul(a, o, r, n)
    }, {
      $a: a,
      $b: o
    }, function (e) {
      return r || n ? !r && n ? {
        $a: function () {
          return e.matMul(o.toFloat(), !1, !1)
        },
        $b: function () {
          return e.matMul(a.toFloat(), !0, !1)
        }
      } : r && !n ? {
        $a: function () {
          return o.toFloat().matMul(e, !1, !0)
        },
        $b: function () {
          return a.toFloat().matMul(e, !1, !1)
        }
      } : {
        $a: function () {
          return o.toFloat().matMul(e, !0, !0)
        },
        $b: function () {
          return e.matMul(a.toFloat(), !0, !0)
        }
      } : {
        $a: function () {
          return e.matMul(o.toFloat(), !1, !0)
        },
        $b: function () {
          return a.toFloat().matMul(e, !0, !1)
        }
      }
    })
  }
  ...
  function maxPool_(e, t, r, n, a) {
    var o = convertToTensor(e, "x", "maxPool"),
      i = o,
      s = !1;
    3 === o.rank && (s = !0, i = o.as4D(1, o.shape[0], o.shape[1], o.shape[2])), assert(4 === i.rank, "Error in maxPool: input must be rank 4 but got rank " + i.rank + "."), null != a && assert(isInt(n), "Error in maxPool: pad must be an integer when using, dimRoundingMode " + a + " but got pad " + n + ".");
    var u = computePool2DInfo(i.shape, t, r, n, a),
      l = ENV.engine.runKernel(function (e, t) {
        ...
        return {
          x: function () {
            return maxPoolBackprop(e, i, o, t, r, n)
          }
        }
      });
  ...
  function avgPool_(e, t, r, n, a) {
    var o = convertToTensor(e, "x", "avgPool");
    assert("float32" === o.dtype, "The input dtype to avgPool must be float32");
    var i = o,
      s = !1;
    3 === o.rank && (s = !0, i = o.as4D(1, o.shape[0], o.shape[1], o.shape[2])), assert(4 === i.rank, "Error in avgPool: x must be rank 4 but got rank " + i.rank + "."), null != a && assert(isInt(n), "Error in avgPool: pad must be an integer when using, dimRoundingMode " + a + " but got pad " + n + ".");
    var u = computePool2DInfo(i.shape, t, r, n),
      l = ENV.engine.runKernel(function (e) {
        ...
        return {
          x: function () {
            return avgPoolBackprop(e, i, t, r, n)
          }
        }
      });
    return l = l.cast(o.dtype), s ? l.as3D(l.shape[1], l.shape[2], l.shape[3]) : l
  }

  function maxPoolBackprop(e, t, r, n, a, o, i) {
    var s = convertToTensor(e, "dy", "maxPoolBackprop"),
      u = convertToTensor(t, "input", "maxPoolBackprop"),
      l = convertToTensor(r, "output", "maxPoolBackprop");
    ...
    var p = computePool2DInfo(u.shape, n, a, o, i);
    return ENV.engine.runKernel(function (e) {
      return e.maxPoolBackprop(s, u, l, p)
    }, {
      $dy: s,
      $input: u
    })
  ...
  function avgPoolBackprop(e, t, r, n, a) {
    var o = convertToTensor(e, "dy", "avgPoolBackprop"),
      i = convertToTensor(t, "input", "avgPoolBackprop");
    assert(i.rank === o.rank, "Rank of input (" + i.rank + ") does not match rank of dy (" + o.rank + ")");
    var s = i,
      u = o,
      l = !1;
    3 === i.rank && (l = !0, s = i.as4D(1, i.shape[0], i.shape[1], i.shape[2]), u = o.as4D(1, o.shape[0], o.shape[1], o.shape[2])), assert(4 === u.rank, "Error in avgPoolBackprop: dy must be rank 4 but got rank " + u.rank + "."), assert(4 === s.rank, "Error in avgPoolBackprop: input must be rank 4 but got rank " + s.rank + ".");
    var p = computePool2DInfo(s.shape, r, n, a),
      c = ENV.engine.runKernel(function (e) {
        return e.avgPoolBackprop(u, s, p)
      }, {
        dy4D: u,
        input4D: s
      });
  ...
  function slice2d_(e, t, r) {
    ...
    return assert(2 === n.rank, "slice1d expects a rank-2 tensor, but got a rank-" + n.rank + " tensor"), slice(n, t, r)
  }

  function slice3d_(e, t, r) {
    var n = convertToTensor(e, "x", "slice3d");
    return assert(3 === n.rank, "slice1d expects a rank-3 tensor, but got a rank-" + n.rank + " tensor"), slice(n, t, r)
  }

  function slice4d_(e, t, r) {
    var n = convertToTensor(e, "x", "slice4d");
    return assert(4 === n.rank, "slice1d expects a rank-4 tensor, but got a rank-" + n.rank + " tensor"), slice(n, t, r)
  }

  function slice_(e, t, r) {
    var n, a, o = convertToTensor(e, "x", "slice");
    if (0 === o.rank) throw new Error("Slicing scalar is not possible");
    n = "number" == typeof t ? [t].concat(new Array(o.rank - 1).fill(0)) : t.length < o.rank ? t.concat(new Array(o.rank - t.length).fill(0)) : t, a = (a = null == r ? new Array(o.rank).fill(-1) : "number" == typeof r ? [r].concat(new Array(o.rank - 1).fill(-1)) : r.length < o.rank ? r.concat(new Array(o.rank - r.length).fill(-1)) : r).map(function (e, t) {
  ...
  function add_(e, t) {
    ...
    var a = assertAndGetBroadcastShape(r.shape, n.shape);
    return ENV.engine.runKernel(function (e) {
      return e.add(r, n)
    }, {
      $a: r,
  ...
  function pow_(e, t) {
    ...
    return e = r.cast(upcastType(r.dtype, n.dtype)), t = n.cast(upcastType(r.dtype, n.dtype)), ENV.engine.runKernel(function (e, t) {
      ...
      return {
        $base: function () {
          var t = e.mul(n.toFloat().mul(o.div(r))),
            i = getReductionAxes(r.shape, a);
          return i.length > 0 && (t = t.sum(i)), t.reshape(r.shape)
        },
        $exp: function () {
          var t = e.mul(o.mul(r.log()).toFloat()),
            i = getReductionAxes(n.shape, a);
    ...
    return ENV.engine.runKernel(function (e) {
      ...
      return {
        $a: function () {
          ...
          return o.length > 0 ? t.sum(o).reshape(r.shape) : t
        },
        $b: function () {
          var t = e.mul(r.toFloat()),
            o = getReductionAxes(n.shape, a);
          return o.length > 0 ? t.sum(o).reshape(n.shape) : t
        }
      }
    })
  }
  ...
  function div_(e, t) {
    var r, n = convertToTensor(e, "a", "div"),
      a = convertToTensor(t, "b", "div");
    if (assertTypesMatch(n, a), "int32" === n.dtype && "int32" === a.dtype) return floorDiv(n, a);
    r = function (e) {
      return e.realDivide(n, a)
    };
    ...
    return ENV.engine.runKernel(function (e) {
      ...
      return {
        ...
        $b: function () {
          var t = e.mul(r.toFloat()),
            o = getReductionAxes(n.shape, a);
          o.length > 0 && (t = t.sum(o).reshape(n.shape));
          var i = n.square();
          return t.div(i.toFloat()).neg()
        }
      }
  ...
  function minimum_(e, t) {
    ...
    return assertTypesMatch(r, n), "bool" === r.dtype && (r = r.toInt()), "bool" === n.dtype && (n = n.toInt()), assertAndGetBroadcastShape(r.shape, n.shape), ENV.engine.runKernel(function (e) {
  ...
  function where_(e, t, r) {
    ...
    return assert("bool" === o.dtype, "Error Condition must be of type bool."), assertShapesMatch(n.shape, a.shape, "Error in where: "), 1 === o.rank ? assert(o.shape[0] === n.shape[0], "The first dimension of `a` must match the size of `condition`.") : assertShapesMatch(o.shape, a.shape, "Error in where: "), ENV.engine.runKernel(function (e) {
      ...
      return {
        ...
        $a: function () {
          return e.mul(o.cast(n.dtype))
        },
        $b: function () {
          return e.mul(o.logicalNot().cast(a.dtype))
        }
      }
    })
  }
  ...
  function prelu_(e, t) {
    var r = convertToTensor(e, "x", "prelu"),
      ...
      a = scalar(0);
    return maximum(a, r).add(n.mul(minimum(a, r)))
  }
  var elu = op({
      elu_: elu_
    }),
  ...
  function unsortedSegmentSum_(e, t, r) {
    ...
    return assert("int32" === a.dtype, "segmentIds must be of dtype `int32`"), assert(isInt(r), "numSegments must be of dtype int"), ENV.engine.runKernel(function (e) {
  ...
  function gather_(e, t, r) {
    ...
    return assert("int32" === a.dtype, "Indices must be of dtype `int32`"), r = parseAxisParam(r, n.shape)[0], ENV.engine.runKernel(function (e) {
      return e.gather(n, a, r)
    }, {
      $x: n
    }, function (e) {
      return {
        $x: function () {
          if (0 === r) return unsortedSegmentSum(e, a, n.shape[r]);
          var t = n.shape,
            o = a.size,
            i = t.slice(0, r),
            s = i.length,
  ...
  function gatherDropNegatives(e, t) {
    for (var r = maximum(t, zerosLike(t)), n = gather(e, r), a = greaterEqual(t, scalar(0, "int32")), o = n.rank - a.rank, i = 0; i < o; ++i) a = expandDims(a, i + 1);
  ...
  function multiRNNCell_(e, t, r, n) {
    ...
    var c = [],
      d = [];
    for (l = 0; l < u.length; l += 2) c.push(u[l]), d.push(u[l + 1]);
    return [c, d]
  }
  ...
  function basicLSTMCell_(e, t, r, n, a, o) {
    var i = convertToTensor(e, "forgetBias", "basicLSTMCell"),
      ...
      v = d.slice([0, 2 * f], m),
      b = d.slice([0, 3 * f], m),
      x = g.sigmoid().mulStrict(y.tanh()).addStrict(p.mulStrict(i.add(v).sigmoid()));
  ...
  function stridedSlice_(e, t, r, n, a, o) {
    void 0 === a && (a = 0), void 0 === o && (o = 0);
    var i = convertToTensor(e, "x", "stridedSlice");
    return ENV.engine.runKernel(function (e) {
      return e.stridedSlice(i, t, r, n, a, o)
    }, {
      $x: i
    })
  }
  ...
  function huberLoss_(e, t, r, n, a) {
    ...
    var u = scalar(n),
      ...
      p = minimum(l, u),
      c = l.sub(p),
      d = scalar(.5).mul(p.square()).add(u.mul(c));
    return computeWeightedLoss(d, s, a)
  }
  ...
  function qr2d(e, t) {
    return void 0 === t && (t = !1), ENV.engine.tidy(function () {
      ...
      for (var r = e.shape[0], n = e.shape[1], a = eye(r), o = e.clone(), i = tensor2d([
          [1]
        ], [1, 1]), s = i.clone(), u = r >= n ? n : r, l = function (e) {
          var t, u = o,
            l = s,
            p = a;
  ...
  var resizeBilinear = op({
    ...
    MathBackendCPU = function () {
      ...
      return e.prototype.register = function (e, t, r) {
        ...
        if (null != e.getContext) r = e.getContext("2d").getImageData(0, 0, e.width, e.height).data;
        else if (e instanceof ImageData) r = e.data;
        else {
        ...
        for (var l = buffer(u, e.dtype), p = 0; p < l.size; p++) {
          for (var c = l.indexToLoc(p), d = new Array(c.length), h = 0; h < d.length; h++) d[h] = c[h] * n[h] + s[h];
          l.set.apply(l, [e.get.apply(e, d)].concat(c))
        }
        return l.toTensor()
      }, e.prototype.reverse = function (e, t) {
        ...
        var r = computeOutShape$1(e.shape, t.shape, 1),
          n = buffer(r, e.dtype);
        ...
        for (var t = e.map(function (e) {
          ...
          for (var o = t[a], i = 0; i < n.length; i++) n[i] += o[i];
        return r.toTensor()
      }, e.prototype.subtract = function (e, t) {
        return this.broadcastedBinaryOp(e, t, upcastType(e.dtype, t.dtype), function (e, t) {
          return e - t
        ...
        for (var a = r ? e.shape[0] : e.shape[1], o = r ? e.shape[1] : e.shape[0], i = n ? t.shape[0] : t.shape[1], s = e.dataSync(), u = t.dataSync(), l = r ? [1, e.strides[0]] : [e.strides[0], 1], p = l[0], c = l[1], d = n ? [t.strides[0], 1] : [1, t.strides[0]], h = d[0], f = d[1], m = o * p, g = i * h, y = new Float32Array(o * i), v = 0, b = 0; b < m; b += p)
          for (var x = 0; x < g; x += h) {
            for (var w = b, S = x, N = 0, T = 0; T < a; ++T) N += s[w] * u[S], w += c, S += f;
            y[v++] = N
          }
        ...
        for (var r = computeOutAndReduceShapes(e.shape, t), n = r[0], a = r[1], o = zeros(n, upcastType(e.dtype, "int32")), i = sizeFromShape(a), s = o.dataSync(), u = e.dataSync(), l = 0; l < s.length; ++l) {
          for (var p = l * i, c = 0, d = 0; d < i; ++d) c += u[p + d];
          s[l] = c
        }
        return o
      }, e.prototype.unsortedSegmentSum = function (e, t, r) {
        for (var n = [], a = e.rank - t.rank, o = 0; o < a; ++o) t = t.expandDims(o + 1);
        for (o = 0; o < r; ++o) {
        ...
        for (var n = computeOutAndReduceShapes(e.shape, r), a = n[0], o = n[1], i = zeros(a, "int32"), s = sizeFromShape(o), u = i.dataSync(), l = e.dataSync(), p = 0; p < u.length; ++p) {
          for (var c = p * s, d = l[c], h = 0, f = 0; f < s; ++f) {
            var m = l[c + f];
            m < d && (d = m, h = f)
          }
          u[p] = h
        ...
        for (var n = e.dataSync(), a = t.dataSync(), o = r.dataSync(), i = zeros(t.shape, upcastType(t.dtype, r.dtype)), s = i.dataSync(), u = 0, l = 0 === e.rank || e.rank > 1 || 1 === t.rank ? 1 : t.shape[1], p = 0; p < n.length; p++)
          for (var c = 0; c < l; c++) 1 === n[p] ? s[u++] = a[p] : s[u++] = o[p];
        return i
      }, e.prototype.where = function (e) {
        var t = e.dataSync();
        return whereImpl(e.shape, t)
        ...
        for (var n = r.filterHeight, a = r.filterWidth, o = r.dilationHeight, i = r.dilationWidth, s = r.padInfo.left, u = r.padInfo.top, l = buffer(r.outShape, e.dtype), p = 0; p < r.batchSize; ++p)
          for (var c = 0; c < r.outChannels; ++c)
                ...
                for (var m = f * r.strideWidth - u, g = 0, y = 0; y < n; y++) {
                  ...
                  if (!(v < 0 || v >= r.inHeight))
                    for (var b = 0; b < a; b++) {
                      var x = m + b * i;
                      if (!(x < 0 || x >= r.inWidth))
                        for (var w = 0; w < r.inChannels; ++w) g += e.get(p, v, x, w) * t.get(y, b, w, c)
                    }
                }
                l.set(g, p, d, f, c)
              }
        ...
        for (var n = buffer(r.inShape, "float32"), a = n.values, o = n.strides, i = o[0], s = o[1], u = o[2], l = e.dataSync(), p = e.strides, c = p[0], d = p[1], h = p[2], f = t.dataSync(), m = t.strides, g = m[0], y = m[1], v = m[2], b = r.batchSize, x = r.filterHeight, w = r.filterWidth, S = r.inChannels, N = r.inHeight, T = r.inWidth, E = r.outChannels, I = r.outHeight, A = r.outWidth, _ = r.strideHeight, P = r.strideWidth, C = x - 1 - r.padInfo.top, k = w - 1 - r.padInfo.left, O = 0; O < b; ++O)
          for (var R = 0; R < S; ++R)
            for (var D = 0; D < N; ++D)
              for (var z = D - C, M = Math.max(0, Math.ceil(z / _)), L = Math.min(I, (x + z) / _), V = 0; V < T; ++V) {
                for (var F = V - k, B = Math.max(0, Math.ceil(F / P)), $ = Math.min(A, (w + F) / P), U = 0, W = M; W < L; ++W)
                  for (var q = W * _ - z, G = B; G < $; ++G)
                    for (var H = c * O + d * W + h * G, j = g * (x - 1 - q) + y * (w - 1 - (G * P - F)) + v * R, K = 0; K < E; ++K) U += l[H + K] * f[j + K];
                a[i * O + s * D + u * V + R] = U
              }
        return n.toTensor()
      }, e.prototype.conv2dDerFilter = function (e, t, r) {
        for (var n = r.strideHeight, a = r.strideWidth, o = r.filterHeight, i = r.filterWidth, s = buffer(r.filterShape, "float32"), u = r.padInfo.left, l = r.padInfo.top, p = 0; p < o; ++p)
          for (var c = Math.max(0, Math.ceil((l - p) / n)), d = Math.min(r.outHeight, (r.inHeight + l - p) / n), h = 0; h < i; ++h)
            for (var f = Math.max(0, Math.ceil((u - h) / a)), m = Math.min(r.outWidth, (r.inWidth + u - h) / a), g = 0; g < r.inChannels; ++g)
              for (var y = 0; y < r.outChannels; ++y) {
                for (var v = 0, b = 0; b < r.batchSize; ++b)
                  for (var x = c; x < d; ++x)
                    for (var w = p + x * n - l, S = f; S < m; ++S) {
                      var N = h + S * a - u;
                      v += e.get(b, w, N, g) * t.get(b, x, S, y)
                    }
                s.set(v, p, h, g, y)
              }
        return s.toTensor()
      }, e.prototype.depthwiseConv2D = function (e, t, r) {
        for (var n = r.filterHeight, a = r.filterWidth, o = r.dilationHeight, i = r.dilationWidth, s = r.padInfo.left, u = r.padInfo.top, l = r.outChannels / r.inChannels, p = buffer(r.outShape, e.dtype), c = 0; c < r.batchSize; ++c)
                ...
                for (var g = m * r.strideWidth - u, y = 0; y < l; ++y) {
                  for (var v = 0, b = 0; b < n; ++b) {
                    ...
                    if (!(x < 0 || x >= r.inHeight))
                      for (var w = 0; w < a; ++w) {
                        var S = g + w * i;
                        S < 0 || S >= r.inWidth || (v += e.get(c, x, S, d) * t.get(b, w, d, y))
                      }
                  }
                  p.set(v, c, h, m, d * l + y)
                }
        ...
        for (var n = buffer(r.inShape, "float32"), a = n.values, o = n.strides, i = o[0], s = o[1], u = o[2], l = e.dataSync(), p = e.strides, c = p[0], d = p[1], h = p[2], f = t.dataSync(), m = t.strides, g = m[0], y = m[1], v = m[2], b = r.batchSize, x = r.filterHeight, w = r.filterWidth, S = r.inChannels, N = r.inHeight, T = r.inWidth, E = r.outChannels, I = r.outHeight, A = r.outWidth, _ = r.strideHeight, P = r.strideWidth, C = x - 1 - r.padInfo.top, k = w - 1 - r.padInfo.left, O = E / S, R = 0; R < b; ++R)
          for (var D = 0; D < S; ++D)
            for (var z = 0; z < N; ++z)
              for (var M = z - C, L = Math.max(0, Math.ceil(M / _)), V = Math.min(I, (x + M) / _), F = 0; F < T; ++F) {
                for (var B = F - k, $ = Math.max(0, Math.ceil(B / P)), U = Math.min(A, (w + B) / P), W = 0, q = L; q < V; ++q)
                  for (var G = q * _ - M, H = $; H < U; ++H)
                    for (var j = c * R + d * q + h * H, K = g * (x - 1 - G) + y * (w - 1 - (H * P - B)) + v * D, X = 0; X < O; ++X) W += l[j + (D * O + X)] * f[K + X];
                a[i * R + s * z + u * F + D] = W
              }
        return n.toTensor()
      }, e.prototype.depthwiseConv2DDerFilter = function (e, t, r) {
        for (var n = r.strideHeight, a = r.strideWidth, o = r.filterHeight, i = r.filterWidth, s = buffer(r.filterShape, "float32"), u = r.padInfo.left, l = r.padInfo.top, p = r.outChannels / r.inChannels, c = 0; c < o; ++c)
          for (var d = Math.max(0, Math.ceil((l - c) / n)), h = Math.min(r.outHeight, (r.inHeight + l - c) / n), f = 0; f < i; ++f)
            for (var m = Math.max(0, Math.ceil((u - f) / a)), g = Math.min(r.outWidth, (r.inWidth + u - f) / a), y = 0; y < r.outChannels; ++y) {
              for (var v = Math.trunc(y / p), b = y % p, x = 0, w = 0; w < r.batchSize; ++w)
                for (var S = d; S < h; ++S)
                  for (var N = c + S * n - l, T = m; T < g; ++T) {
                    var E = f + T * a - u;
                    x += e.get(w, N, E, v) * t.get(w, S, T, y)
                  }
              s.set(x, c, f, v, b)
            }
        return s.toTensor()
        ...
        for (var n = t.strideHeight, a = t.strideWidth, o = t.filterHeight, i = t.filterWidth, s = buffer(t.outShape, "float32"), u = t.padInfo.top, l = t.padInfo.left, p = 0; p < t.batchSize; ++p)
          for (var c = 0; c < t.inChannels; ++c)
            for (var d = 0; d < t.outHeight; ++d)
              for (var h = d * n - u, f = Math.max(0, h), m = Math.min(t.inHeight, o + h), g = 0; g < t.outWidth; ++g) {
                for (var y = g * a - l, v = Math.max(0, y), b = Math.min(t.inWidth, i + y), x = "max" === r ? Number.NEGATIVE_INFINITY : Number.POSITIVE_INFINITY, w = 0, S = 0, N = f; N < m; ++N) {
                  for (var T = v; T < b; ++T) {
                    var E = e.get(p, N, T, c);
        ...
        for (var r = buffer(t.outShape, "int32"), n = t.strideHeight, a = t.strideWidth, o = t.filterHeight, i = t.filterWidth, s = t.padInfo.top, u = t.padInfo.left, l = 0; l < t.batchSize; ++l)
          for (var p = 0; p < t.inChannels; ++p)
            for (var c = 0; c < t.outHeight; ++c)
              for (var d = c * n - s, h = Math.max(0, d), f = Math.min(t.inHeight, o + d), m = 0; m < t.outWidth; ++m) {
                for (var g = m * a - u, y = Math.max(0, g), v = Math.min(t.inWidth, i + g), b = Number.NEGATIVE_INFINITY, x = -1, w = h; w < f; ++w)
                  for (var S = w - d, N = y; N < v; ++N) {
                    var T = N - g,
                      E = e.get(l, w, N, p);
                    E > b && (b = E, x = S * i + T)
                  }
        ...
        for (var a = this.maxPoolPositions(t, n), o = n.strideHeight, i = n.strideWidth, s = n.filterHeight, u = n.filterWidth, l = u - 1 - n.padInfo.left, p = s - 1 - n.padInfo.top, c = buffer(t.shape, "float32"), d = 0; d < n.batchSize; ++d)
          for (var h = 0; h < n.inChannels; ++h)
            for (var f = 0; f < n.inHeight; ++f)
              for (var m = 0; m < n.inWidth; ++m) {
                for (var g = f - p, y = m - l, v = 0, b = 0; b < s; ++b) {
                  var x = (g + b) / o;
                  if (!(x < 0 || x >= n.outHeight || Math.floor(x) !== x))
                    for (var w = 0; w < u; ++w) {
                      var S = (y + w) / i;
                      if (!(S < 0 || S >= n.outWidth || Math.floor(S) !== S)) {
                        var N = s * u - 1 - a.get(d, x, S, h) === b * u + w ? 1 : 0;
                        0 !== N && (v += e.get(d, x, S, h) * N)
                      }
                    }
                }
                c.set(v, d, f, m, h)
        ...
        for (var n = r.strideHeight, a = r.strideWidth, o = r.filterHeight, i = r.filterWidth, s = i - 1 - r.padInfo.left, u = o - 1 - r.padInfo.top, l = buffer(t.shape, "float32"), p = 1 / (o * i), c = 0; c < r.batchSize; ++c)
          for (var d = 0; d < r.inChannels; ++d)
              ...
              for (var f = 0; f < r.inWidth; ++f) {
                for (var m = h - u, g = f - s, y = 0, v = 0; v < o; ++v) {
                  ...
                  if (!(b < 0 || b >= r.outHeight || Math.floor(b) !== b))
                    for (var x = 0; x < i; ++x) {
                      var w = (g + x) / a;
                      w < 0 || w >= r.outWidth || Math.floor(w) !== w || (y += e.get(c, b, w, d))
                    }
                }
                l.set(y * p, c, h, f, d)
              }
        ...
        for (var a = e.shape, o = a[0], i = a[1], s = a[2], u = a[3], l = buffer([o, t, r, u], e.dtype), p = [n && t > 1 ? i - 1 : i, n && r > 1 ? s - 1 : s], c = [n && t > 1 ? t - 1 : t, n && r > 1 ? r - 1 : r], d = 0; d < o; d++)
          for (var h = 0; h < t; h++)
            for (var f = 0; f < r; f++)
              for (var m = 0; m < u; m++) {
                var g = p[0] * h / c[0],
                  ...
                  N = e.get(d, b, x, m),
                  T = y - x,
                  E = S + (e.get(d, v, w, m) - S) * T,
                  I = E + (N + (e.get(d, b, w, m) - N) * T - E) * (g - v);
                l.set(I, d, h, f, m)
              }
        return l.toTensor()
      }, e.prototype.resizeBilinearBackprop = function (e, t, r) {
        for (var n = t.shape, a = n[0], o = n[1], i = n[2], s = n[3], u = e.shape, l = u[1], p = u[2], c = buffer([a, o, i, s], t.dtype), d = [r && l > 1 ? o - 1 : o, r && p > 1 ? i - 1 : i], h = [r && l > 1 ? l - 1 : l, r && p > 1 ? p - 1 : p], f = d[0] / h[0], m = d[1] / h[1], g = 0; g < a; g++)
          for (var y = 0; y < l; y++)
            for (var v = y * f, b = Math.floor(v), x = Math.min(Math.ceil(v), o - 1), w = v - b, S = 1 - w, N = 0; N < p; N++)
              for (var T = N * m, E = Math.floor(T), I = Math.min(Math.ceil(T), i - 1), A = T - E, _ = 1 - A, P = 0; P < s; P++) {
                var C = e.get(g, y, N, P),
                  k = c.get(g, b, E, P);
                k += C * S * _, c.set(k, g, b, E, P);
                var O = c.get(g, b, I, P);
                O += C * S * A, c.set(O, g, b, I, P);
                var R = c.get(g, x, E, P);
                R += C * w * _, c.set(R, g, x, E, P);
                var D = c.get(g, x, I, P);
                D += C * w * A, c.set(D, g, x, I, P)
              }
        return c.toTensor()
      }, e.prototype.resizeNearestNeighbor = function (e, t, r, n) {
        for (var a = e.shape, o = a[0], i = a[1], s = a[2], u = a[3], l = buffer([o, t, r, u], e.dtype), p = [n && t > 1 ? i - 1 : i, n && r > 1 ? s - 1 : s], c = [n && t > 1 ? t - 1 : t, n && r > 1 ? r - 1 : r], d = 0; d < o; d++)
        ...
        for (var n = t.shape, a = n[0], o = n[1], i = n[2], s = n[3], u = e.shape, l = u[1], p = u[2], c = buffer([a, o, i, s], t.dtype), d = [r && l > 1 ? o - 1 : o, r && p > 1 ? i - 1 : i], h = [r && l > 1 ? l - 1 : l, r && p > 1 ? p - 1 : p], f = 1 / (d[0] / h[0]), m = 1 / (d[1] / h[1]), g = 2 * Math.ceil(f) + 2, y = 2 * Math.ceil(m) + 2, v = 0; v < a; v++)
          for (var b = 0; b < o; b++)
            for (var x = 0; x < i; x++)
              for (var w = Math.floor(b * f), S = Math.floor(w - g / 2), N = Math.floor(x * m), T = Math.floor(N - y / 2), E = 0; E < s; E++) {
                  ...
                  if (!(_ < 0 || _ >= l))
                    for (var P = 0; P < y; P++) {
                      ...
                      if (!(C < 0 || C >= p)) {
                        var k = d[0] * (_ / h[0]),
                          O = d[1] * (C / h[1]),
                          R = Math.min(o - 1, r ? Math.round(k) : Math.floor(k)),
                          D = Math.min(i - 1, r ? Math.round(O) : Math.floor(O));
                        b === R && x === D && (I += e.get(v, _, C, E))
                      }
                    }
                }
                c.set(I, v, b, x, E)
        ...
        for (var i = e.dataSync(), s = t.dataSync(), u = r.dataSync(), l = a ? a.dataSync() : new Float32Array([1]), p = o ? o.dataSync() : new Float32Array([0]), c = new Float32Array(i.length), d = 0; d < i.length; d++) c[d] = p[d % p.length] + (i[d] - s[d % s.length]) * l[d % l.length] / Math.sqrt(u[d % u.length] + n);
        ...
        for (var l = 0; l < o.shape[0]; l++)
          for (var p = 0; p <= o.shape[1]; p++)
            for (var c = 0; c < o.shape[2]; c++)
              for (var d = 0; d < o.shape[3]; d++) {
                var h = u(l, p, c, d),
                  f = e.get(l, p, c, d) * Math.pow(r + n * h, -a);
                o.set(f, l, p, c, d)
              }
        return o.toTensor()
      }, e.prototype.LRNGrad = function (e, t, r, n, a, o, i) {
        for (var s = e.shape[0], u = e.shape[1], l = e.shape[2], p = e.shape[3], c = buffer([s, u, l, p], "float32"), d = 0; d < s; ++d)
          for (var h = 0; h < u; ++h)
            for (var f = 0; f < l; ++f)
              for (var m = 0; m < p; ++m) {
                for (var g = Math.max(0, m - n), y = Math.min(p, m + n + 1), v = 0, b = g; b < y; ++b) v += t.get(d, h, f, b) * t.get(d, h, f, b);
                for (v = o * v + a, b = g; b < y; ++b) {
                  var x = -2 * o * i * t.get(d, h, f, b) * r.get(d, h, f, m) / v;
                  m === b && (x += Math.pow(v, -i)), x *= e.get(d, h, f, m), c.set(x + c.get(d, h, f, b), d, h, f, b)
                }
              }
        return c.toTensor()
      }, e.prototype.multinomial = function (e, t, r, n) {
        for (var a = t ? e : softmax(e), o = a.shape[0], i = a.shape[1], s = zeros([o, r], "int32"), u = s.dataSync(), l = a.dataSync(), p = 0; p < o; ++p) {
          ...
          d[0] = l[c];
          for (var h = 1; h < d.length; ++h) d[h] = d[h - 1] + l[c + h];
        ...
        a.fill(n);
        for (var o = 0; o < e.size; ++o) e.get(o) >= 0 && e.get(o) < t && (a[o * t + e.get(o)] = r);
        return tensor2d(a, [e.size, t], "int32")
      }, e.prototype.nonMaxSuppression = function (e, t, r, n, a) {
        return nonMaxSuppressionImpl(e.dataSync(), t.dataSync(), r, n, a)
      }, e.prototype.broadcastedBinaryOp = function (e, t, r, n) {
        for (var a = assertAndGetBroadcastShape(e.shape, t.shape), o = buffer(a, r), i = e.dataSync(), s = t.dataSync(), u = getBroadcastDims(e.shape, a), l = getBroadcastDims(t.shape, a), p = e.buffer(), c = t.buffer(), d = function (r) {
            var a = o.indexToLoc(r),
              d = a.slice(-e.rank);
            u.forEach(function (e) {
              return d[e] = 0
            });
            var h = p.locToIndex(d),
              f = a.slice(-t.rank);
            l.forEach(function (e) {
              return f[e] = 0
            });
            var m = c.locToIndex(f);
            o.values[r] = n(i[h], s[m])
          }, h = 0; h < o.values.length; ++h) d(h);
        return o.toTensor()
  ...
  function decodeWeights(e, t) {
    for (var r = {}, n = 0, a = 0, o = t; a < o.length; a++) {
      ...
      var p = sizeFromShape(l),
        c = void 0;
      if ("float32" === u) c = tensor(new Float32Array(e, n, p), l, "float32");
      else if ("int32" === u) c = tensor(new Int32Array(e, n, p), l, "int32");
      else {
        if ("bool" !== u) throw new Error("Unsupported dtype in weight '" + s + "': " + u);
        c = tensor(new Uint8Array(e, n, p), l, "bool")
      }
      r[s] = c, n += p * DTYPE_VALUE_SIZE_MAP[u]
    }
    return r
  }
  ...
  function base64StringToArrayBuffer(e) {
    ...
    for (var r = atob(e), n = new Uint8Array(r.length), a = 0; a < r.length; ++a) n.set([r.charCodeAt(a)], a);
    return n.buffer
  }
    ...
    return void 0 === r && (r = !1), __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (d) {
        switch (d.label) {
          ...
          case 1:
            return p = d.sent(), r && l ? [4, ModelStoreManagerRegistry.getManager(s).removeModel(u)] : [3, 3];
          case 2:
            d.sent(), d.label = 3;
          case 3:
            return [4, i.save(p)];
          case 4:
            return c = d.sent(), !r || l ? [3, 6] : [4, ModelStoreManagerRegistry.getManager(s).removeModel(u)];
          case 5:
            d.sent(), d.label = 6;
          case 6:
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (s) {
        switch (s.label) {
          ...
          case 2:
            for (i in o = s.sent()) t[a + URL_SCHEME_SUFFIX + i] = o[i];
            s.label = 3;
          case 3:
            return r++, [3, 1];
          case 4:
        ...
        switch (f.label) {
          case 0:
            ...
            return l = a.reduce(function (e, t, r) {
              return t && e.push(r), e
            }, []), p = [], l.forEach(function (r) {
              e[r].paths.forEach(function (e) {
                var r = t + (t.endsWith("/") ? "" : "/") + e;
                p.push(r)
              })
            }), [4, loadWeightsAsArrayBuffer(p, n)];
          case 1:
            return c = f.sent(), d = {}, h = 0, l.forEach(function (t) {
              for (var r = e[t].paths.length, n = 0, a = 0; a < r; a++) n += c[h + a].byteLength;
              for (var i = new ArrayBuffer(n), s = new Uint8Array(i), u = 0, l = 0; l < r; l++) {
                var p = new Uint8Array(c[h + l]);
              ...
              o[t].forEach(function (e) {
                ...
                else if ("int32" === n) t = new Int32Array(r);
                else {
                  if ("bool" !== n) throw new Error("Weight " + e.manifestEntry.name + " has unknown dtype " + n + ".");
                  t = new Uint8Array(r)
                }
          ...
          return __generator(this, function (d) {
            switch (d.label) {
              ...
              case 2:
                ...
                for (o = e.weightsManifest, n = [], i = 0, s = o; i < s.length; i++) u = s[i], n.push.apply(n, u.weights);
                return (l = this.path.substring(0, this.path.lastIndexOf("/"))).endsWith("/") || (l += "/"), p = [], o.forEach(function (e) {
                  e.paths.forEach(function (e) {
                    p.push(l + e)
                  })
                }), c = concatenateArrayBuffers, [4, loadWeightsAsArrayBuffer(p, this.requestInit)];
              case 3:
                a = c.apply(void 0, [d.sent()]), d.label = 4;
              case 4:
                return [2, {
                  modelTopology: t,
                  weightSpecs: n,
  ...
  var AdamOptimizer = function (e) {
    function t(t, r, n, a) {
      ...
      }), o.oneMinusBeta1 = keep(scalar(1 - r)), o.oneMinusBeta2 = keep(scalar(1 - n)), o.one = keep(scalar(1)), null === a && (a = getOptimizerDefaultEpsilonValue()), o.epsScalar = keep(scalar(a)), o
    }
    return __extends(t, e), t.prototype.applyGradients = function (e) {
      var t = this;
      tidy(function () {
  ...
  var AdamaxOptimizer = function (e) {
    function t(t, r, n, a, o) {
      ...
      }), i.oneMinusBeta1 = keep(scalar(1 - r)), i.one = keep(scalar(1)), null === a && (a = getOptimizerDefaultEpsilonValue()), i.epsScalar = keep(scalar(a)), i
    }
    return __extends(t, e), t.prototype.applyGradients = function (e) {
      var t = this;
      tidy(function () {
        ...
        for (var a in e) {
          ...
          var s = e[a],
            ...
            d = s.abs(),
            h = c.maximum(d);
          t.accumulatedFirstMoment[a].assign(p), t.accumulatedWeightedInfNorm[a].assign(h);
          var f = n.div(r).mul(p.div(t.epsScalar.add(h))).add(o);
          o.assign(f)
        }
    ...
    return __extends(t, e), t.prototype.applyGradients = function (e) {
      var t = this,
        r = function (r) {
          ...
          var o = n.accumulations[r],
            i = e[r];
          tidy(function () {
            var e, n = t.m.mul(o).add(i);
            e = t.useNesterov ? t.c.mul(i.add(n.mul(t.m))).add(a) : t.c.mul(n).add(a), t.accumulations[r].assign(n), a.assign(e)
          })
        },
        n = this;
      for (var a in e) r(a)
  ...
  var RMSPropOptimizer = function (e) {
    function t(t, r, n, a, o) {
      ...
      var i = e.call(this) || this;
      return i.learningRate = t, i.decay = r, i.momentum = n, i.epsilon = a, i.accumulatedMeanSquares = {}, i.accumulatedMeanGrads = {}, i.accumulatedMoments = {}, i.c = keep(scalar(t)), i.decayScalar = keep(scalar(r)), i.momentumScalar = keep(scalar(n)), i.oneMinusDecay = keep(scalar(1 - r)), i.centered = o, null === a && (a = getOptimizerDefaultEpsilonValue()), i.epsilonScalar = keep(scalar(a)), i
    }
    return __extends(t, e), t.prototype.applyGradients = function (e) {
      var t = this,
        r = function (r) {
          ...
          var o = n.accumulatedMeanSquares[r],
          ...
          tidy(function () {
            ...
            if (t.centered) {
              ...
              l = t.momentumScalar.mul(s).add(t.c.mul(u).div(c.add(t.epsilonScalar).sqrt())), t.accumulatedMeanSquares[r].assign(c), t.accumulatedMoments[r].assign(l), p = a.sub(l), a.assign(p)
            }
          })
        },
        n = this;
  ...
  function deserializeKerasObject(e, t, r, n) {
    ...
    var s, u, l, p = i.className,
      c = void 0,
      d = void 0;
    if (p in r ? (c = (s = r.get(p))[0], d = s[1]) : p in _GLOBAL_CUSTOM_OBJECTS ? (c = (u = _GLOBAL_CUSTOM_OBJECTS.className)[0], d = u[1]) : p in t && (c = (l = t[p])[0], d = l[1]), null == c) throw new ValueError("Unknown " + n + ": " + p);
    if (null != d) {
      ...
      i.config.customObjects = h;
      for (var v = __assign$1({}, _GLOBAL_CUSTOM_OBJECTS), b = 0, x = Object.keys(r); b < x.length; b++) {
        var w = x[b];
        _GLOBAL_CUSTOM_OBJECTS[w] = r[w]
      }
      var S = d(c, i.config);
      return _GLOBAL_CUSTOM_OBJECTS = __assign$1({}, v), S
    }
    v = __assign$1({}, _GLOBAL_CUSTOM_OBJECTS);
    for (var N = 0, T = Object.keys(r); N < T.length; N++) w = T[N], _GLOBAL_CUSTOM_OBJECTS[w] = r[w];
    return S = new c(i.config), _GLOBAL_CUSTOM_OBJECTS = __assign$1({}, v), S
  }
  ...
  function dot$1(e, t) {
    if (2 !== t.rank) throw new NotImplementedError("dot support for y other than rank 2 is not yet implemented: y shape = " + t.shape);
  ...
  var DEFAULT_VARIABLE_NAME_PREFIX = "Variable",
    LayerVariable = function () {
      ...
      return e.prototype.read = function () {
        ...
        return this.assertNotDisposed(), checkShapesMatch(this.val, e), this.val.assign(e), null != this.constraint && this.val.assign(this.constraint.apply(this.val)), this
      }, e.prototype.dispose = function () {
  ...
  var InputSpec = function (e) {
    ...
    SymbolicTensor = function (e, t, r, n, a, o, i) {
    ...
    Layer = function (e) {
      function t(t) {
        ...
        return null != t.weights ? r.initialWeights = t.weights : r.initialWeights = null, r._refCount = null, r
      }
      return __extends$1(t, e), t.nodeKey = function (e, t) {
        ...
        if (e = toList(e), null != this.inputSpec && 0 !== this.inputSpec.length) {
          ...
          for (var r = 0; r < e.length; r++) {
            ...
            if (null != a) {
              ...
              if (null != a.shape)
                for (var c = 0; c < a.shape.length; ++c) {
                  var d = a.shape[c],
                    h = n.shape[c];
                  if (null != d && null != h && d !== h) throw new ValueError("Input " + r + " is incompatible with layer " + this.name + ": expected shape=" + a.shape + ", found shape=${xShape}.")
                }
            }
          }
        }
        ...
        return nameScope(this.name, function () {
          ...
          if (r.assertInputCompatibility(e), s) {
            for (var l = [], p = 0, c = toList(m = r.call(e, t)); p < c.length; p++) {
              var d = c[p]; - 1 !== n.indexOf(d) && (d = d.clone()), l.push(d)
            }
          ...
          if (r.warnOnIncompatibleInputShape(Array.isArray(e) ? h[0] : h), m = null != f && f.length > 0 && Array.isArray(f[0]) ? f.map(function (n, a) {
              return new SymbolicTensor(g, n, r, toList(e), t, r.name, a)
            }) : new SymbolicTensor(g, f, r, toList(e), t, r.name), r.addInboundNode(e, m, null, null, h, f, t), r._refCount++, null != r.activityRegularizer) throw new NotImplementedError("Layer invocation in the presence of activity regularizer(s) is not supported yet.");
          return m
        })
        ...
        this._addedWeightNames.push(e), null == r && (r = "float32");
        ...
        for (var u = [], l = [], p = [], c = 0, d = s; c < d.length; c++) {
          var h = d[c];
          u.push(h.sourceLayer), l.push(h.nodeIndex), p.push(h.tensorIndex)
        }
        new Node({
          outboundLayer: this,
          inboundLayers: u,
    ...
    return __awaiter$1(this, void 0, void 0, function () {
      ...
      return __generator$1(this, function (l) {
        switch (l.label) {
          case 0:
            if (null == e) return [2];
            for (a in t = [], r = [], n = [], e) "number" != typeof (o = e[a]) && (i = o, t.push(i.data()), r.push(a), n.push(i));
            return [4, Promise.all(t)];
          case 1:
            for (s = l.sent(), u = 0; u < s.length; ++u) e[r[u]] = s[u][0];
            return dispose(n), [2]
        }
      })
    })
      ...
      return e.prototype.resolveOneTensorInLogs = function (e) {
        return __awaiter$1(this, void 0, void 0, function () {
          ...
          return __generator$1(this, function (i) {
            switch (i.label) {
              case 0:
                for (r in t = [], e) t.push(r);
                n = 0, i.label = 1;
              case 1:
                return n < t.length ? (a = t[n], "number" == typeof (o = e[a]) ? [3, 3] : [4, o.data()]) : [3, 4];
              case 2:
                return i.sent(), [3, 4];
              case 3:
                return n++, [3, 1];
        ...
        return __awaiter$1(this, void 0, void 0, function () {
          ...
          return __generator$1(this, function (a) {
            switch (a.label) {
              ...
              case 1:
                return a.sent(), r = util.now(), [4, nextFrame()];
              case 2:
                return a.sent(), this.batchCount > e.SKIP_FIRST_BATCHES && (this.batchDurationsMillis.push(r - this.batchStartMillis), this.batchDurationsMillis.length >= e.DECISION_BATCH_COUNT && (n = this.batchDurationsMillis.reduce(function (e, t) {
                  return e + t
                }) / this.batchDurationsMillis.length, this.autoYieldEveryBatches = Math.round(e.THRESHOLD_MILLIS / n), this.autoYieldEveryBatches < 1 && (this.autoYieldEveryBatches = 1))), this.batchStartMillis = util.now(), this.lastYieldBatchCount = this.batchCount, [3, 6];
              case 3:
                return this.batchCount - this.lastYieldBatchCount >= this.autoYieldEveryBatches ? [4, nextFrame()] : [3, 6];
              case 4:
                return a.sent(), [4, this.resolveOneTensorInLogs(t)];
              case 5:
                a.sent(), this.lastYieldBatchCount = this.batchCount, a.label = 6;
              case 6:
                return [3, 9];
              case 7:
        ...
        return __awaiter$1(this, void 0, void 0, function () {
          ...
          return __generator$1(this, function (i) {
            switch (i.label) {
              ...
              case 1:
                for (a in i.sent(), null == t && (t = {}), e = null == t.size ? 0 : t.size, this.seen += e, r = function (r) {
                    var a = t[r];
                    if ("number" == typeof a) n.totals.hasOwnProperty(r) || (n.totals[r] = 0), n.totals[r] = n.totals[r] + a * e;
                      ...
                      r in n.totals ? i = n.totals[r] : n.totals[r] = getScalar(0), n.totals[r] = tidy(function () {
                        return add(o.totals[r], mul(a, getScalar(e)))
                      }), null != i && i.dispose()
                    }
                  }, n = this, t) r(a);
                return [2]
                ...
                if (s.sent(), null != t)
                  for (e = function (e) {
                      ...
                      "number" == typeof r.totals[e] ? t[e] = r.totals[e] / r.seen : tidy(function () {
                        t[e] = mul(div(getScalar(1), getScalar(i.seen)), i.totals[e]), i.totals[e].dispose(), keep(t[e])
                      })
  ...
  function categoricalCrossentropy(e, t, r) {
    return void 0 === r && (r = !1), tidy(function () {
      if (r) t = softmax(t);
        ...
        var n = sum(t, t.shape.length - 1, !0);
        t = div(t, n)
      }
  ...
  function sigmoidCrossEntropyWithLogits(e, t) {
    return tidy(function () {
      var r = maximum(t, zerosLike(t)),
        n = mul(t, e),
        a = log$1(add(getScalar(1), exp(neg(abs(t)))));
  ...
  function binaryCrossentropy(e, t) {
    return tidy(function () {
      var r;
      return r = clipByValue(t, epsilon(), 1 - epsilon()), r = log$1(div(r, sub(onesLike(r), r))), mean(sigmoidCrossEntropyWithLogits(e, r), -1)
    })
  }
  ...
  function kullbackLeiblerDivergence(e, t) {
    return tidy(function () {
      ...
      return sum(mul(e, log$1(div(r, n))), -1)
    })
  }
  ...
  function printSummary(e, t, r, n) {
    ...
    var a, o = isModelSequentialLike(e),
      i = ["Layer (type)", "Output shape", "Param #"];
    if (o ? (t = t || 65, r = r || [.45, .85, 1]) : (t = t || 98, r = r || [.33, .55, .67, 1]), r[r.length - 1] <= 1 && (r = r.map(function (e) {
        return Math.floor(t * e)
      })), !o)
      for (var s in i.push("Receives inputs"), a = [], e.nodesByDepth) a.push.apply(a, e.nodesByDepth[s]);
    n("_".repeat(t)), printRow(i, r, n), n("=".repeat(t));
    for (var u = e.layers, l = 0; l < u.length; ++l) o ? printLayerSummary(u[l], r, n) : printLayerSummaryWithConnections(u[l], r, a, n), n((l === u.length - 1 ? "=" : "_").repeat(t));
  ...
  function isModelSequentialLike(e) {
    ...
    if (t)
      for (var u = 0, l = e.layers; u < l.length; u++) {
        for (var p = !1, c = 0, d = l[u].inboundNodes; c < d.length; c++) {
          var h = d[c];
          if (-1 !== n.indexOf(h)) {
            if (p) {
              t = !1;
  ...
  function printLayerSummaryWithConnections(e, t, r, n) {
    ...
    var h = e.name,
      f = e.getClassName(),
      m = 0 === o.length ? "" : o[0];
    for (printRow([h + " (" + f + ")", a, e.countParams().toString(), m], t, n), l = 1; l < o.length; ++l) printRow(["", "", "", o[l]], t, n)
  }
  ...
  function convertPythonicToTs(e, t) {
    ...
    for (var i = {}, s = 0, u = Object.keys(e); s < u.length; s++) {
      var l = u[s],
        p = e[l];
      if ("name" === l && "string" == typeof p) i[l] = p;
      else {
        var c = toCamelCase(l);
    ...
    for (var l = e.weights, p = [], c = 0; c < o.length; ++c) {
      ...
      for (var y = 0, v = i[d]; y < v.length; y++) {
        ...
        if ((f = preprocessWeightsForLoading(b, f, n, a)).length !== x.length) {
          if (!r) throw new ValueError("Layer #" + c + ' (named "' + b.name + '") expects ' + x.length + " weight(s), but the saved weights have " + f.length + " element(s).");
          console.warn("Skipping loading of weights of layer " + b.name + " due to mismatch in number of weights: (" + f.length + " vs " + x.length + ").")
        }
        for (var w = 0; w < f.length; ++w) !r || util.arraysEqual(x[w].shape, f[w].shape) ? p.push([x[w], f[w].read()]) : console.warn("Skipping loading of weights for layer " + b.name + " due to mismatch in shape (" + x[w].shape + " vs " + f[w].shape + ")")
      }
    }
    batchSetValue(p)
  }
  ...
  function loadWeightsFromNamedTensorMap(e, t, r) {
    ...
    var p = [];
    for (var c in e) {
      if (null != n[c]) p.push([n[c], e[c]]);
      else if (r) throw new ValueError("Provided weight data has no target variable: " + c);
      delete n[c]
    }
    if (r) {
      var d = [];
      for (var h in n) d.push(h);
      if (d.length > 0) throw new ValueError(d.length + " of " + a + " weights are not set: " + d)
    }
    batchSetValue(p)
  }
  var Container = function (e) {
    function t(r) {
      ...
      for (var o = 0, i = n.outputs; o < i.length; o++) {
        var s = (I = i[o]).sourceLayer,
          u = I.nodeIndex,
          l = I.tensorIndex;
        n.outputLayers.push(s), n.outputLayersNodeIndices.push(u), n.outputLayersTensorIndices.push(l)
      }
      for (var p = 0, c = n.inputs; p < c.length; p++) s = (I = c[p]).sourceLayer, u = I.nodeIndex, l = I.tensorIndex, assert$1(0 === u, "input layer has >1 nodes"), assert$1(0 === l, "input layer has >1 tensors"), n.inputLayers.push(s), n.inputLayersNodeIndices.push(u), n.inputLayersTensorIndices.push(l);
      ...
      for (var m = {}, g = {}, y = {}, v = {}, b = {}, x = [], w = function (e, r, a, o, i, s) {
          ...
          if (-1 === r.indexOf(u)) {
            n.containerNodes.add(t.nodeKey(o, i)), o.id in b || (b[o.id] = Object.keys(b).length), -1 === a.indexOf(u) && a.push(u);
        ...
        }, S = [], N = [], T = 0, E = n.outputs; T < E.length; T++) {
        var I = E[T];
        w(I, S, N)
      }
      for (var A = 0, _ = x.slice().reverse(); A < _.length; A++) {
        g[(J = _[A]).id] = J, J.id in m || (m[J.id] = 0);
        var P = m[J.id],
          C = null == y[J.outboundLayer.id] ? 0 : y[J.outboundLayer.id];
        for (P = Math.max(P, C), y[J.outboundLayer.id] = P, v[J.outboundLayer.id] = J.outboundLayer, m[J.id] = P, d = 0; d < J.inboundLayers.length; d++) {
          var k = J.inboundLayers[d],
            O = (u = J.nodeIndices[d], k.inboundNodes[u]),
            R = null == m[O.id] ? 0 : m[O.id];
          m[O.id] = Math.max(P + 1, R), g[O.id] = O
        }
      }
      var D = {};
      for (var z in m)(P = m[z]) in D || (D[P] = []), D[P].push(g[z]);
      var M = {};
      for (var L in y)(P = y[L]) in M || (M[P] = []), M[P].push(v[L]);
      ...
      for (var F = 0, B = V; F < B.length; F++) {
        ...
        for (var U = 0, W = $; U < W.length; U++) s = W[U], n.layers.push(s)
      }
      n.layersByDepth = M, V = Object.keys(D).map(function (e) {
        return parseInt(e, 10)
      }).sort(reverseNumberCompare);
      for (var q = n.inputs.slice(), G = [], H = 0, j = V; H < j.length; H++)
        for (var K = 0, X = D[P = j[H]]; K < X.length; K++) {
          var J;
          if (null != (s = (J = X[K]).outboundLayer)) {
            for (var Y = 0, Z = J.inputTensors; Y < Z.length; Y++)
              if (I = Z[Y], -1 === q.indexOf(I)) throw new RuntimeError("Graph disconnected: cannot obtain value for tensor " + I + ' at layer "' + s.name + '". The following previous layers were accessed without issue: ' + G);
            for (var Q = 0, ee = J.outputTensors; Q < ee.length; Q++) I = ee[Q], q.push(I);
            G.push(s.name)
          }
        }
      n.nodesByDepth = D;
    ...
    return __extends$1(t, e), t.prototype.assertNotDisposed = function () {
      ...
      if (0 == --this._refCount)
        for (var t = 0, r = this.layers; t < r.length; t++) {
          var n = r[t];
      ...
      get: function () {
        ...
        if (!this.trainable) {
          for (var a = [], o = 0, i = this.layers; o < i.length; o++) n = i[o], a.push.apply(a, n.trainableWeights);
          return a.concat(e)
        }
        return e
      },
      ...
      for (var s = 0, u = Object.keys(this.nodesByDepth).map(function (e) {
        ...
        for (var l = u[s], p = 0, c = this.nodesByDepth[l]; p < c.length; p++) {
          for (var d = c[p], h = d.outboundLayer, f = d.inputTensors, m = d.outputTensors, g = new Array, y = 0, v = f; y < v.length; y++)(a = v[y]).id in r && g.push(r[a.id]);
          if (g.length === f.length) {
            ...
            if (null != d.callArgs && (b = d.callArgs), 1 === g.length) {
              var T = g[0],
                E = T[0],
                I = T[1];
              null == b.mask && (b.mask = I), S = toList(h.call(E, b)), N = toList(h.computeMask(E, I)), x = [E], w = [I]
            } else x = g.map(function (e) {
              return e[0]
            }), w = g.map(function (e) {
              return e[1]
            }), null == b.mask && (b.mask = w), S = toList(h.call(x, b)), N = toList(h.computeMask(x, w));
            ...
            for (n = 0; n < m.length; ++n) a = m[n], o = S[n], i = N[n], r[a.id] = [o, i]
          }
        }
      for (var A = [], _ = [], P = [], C = 0, k = this.outputs; C < k.length; C++) {
        assert$1((a = k[C]).id in r, "Could not compute output " + a.name + " : " + a.id);
        var O = r[a.id],
          R = O[0];
        i = O[1], P.push(R.shape), A.push(R), _.push(i)
      }
      return [A, _, P]
      ...
      for (var e = {
        ...
        for (var i = (b = o[a]).getClassName(), s = b.getConfig(), u = [], l = 0; l < b.inboundNodes.length; l++) {
          var p = b.inboundNodes[l],
            c = t.nodeKey(b, l),
            d = {};
          if (this.containerNodes.has(c)) {
            if (p.callArgs) try {
              JSON.stringify(p.callArgs), d = p.callArgs
            } catch (e) {
              console.warn("Layer " + b.name + " was passed non-serializable keyword arguments: " + p.callArgs + ". They will not be included in the serialized model (and thus will be missing at deserialization time)."), d = {}
            }
            if (p.inboundLayers.length > 0) {
              for (var h = [], f = 0; f < p.inboundLayers.length; f++) {
      ...
      for (f = 0; f < this.inputLayers.length; f++) {
        ...
        g = this.inputLayersNodeIndices[f], c = t.nodeKey(b, g), this.containerNodes.has(c) && (null !== (w = r[c]) && void 0 !== w || (w = 0), y = this.inputLayersTensorIndices[f], v.push([b.name, w, y]))
      }
      e.inputLayers = v;
      var x = [];
      for (f = 0; f < this.outputLayers.length; f++) {
        var w;
        if (b = this.outputLayers[f], g = this.outputLayersNodeIndices[f], c = t.nodeKey(b, g), this.containerNodes.has(c)) null !== (w = r[c]) && void 0 !== w || (w = 0), y = this.outputLayersTensorIndices[f], x.push([b.name, w, y])
      }
      ...
      function o(e, t) {
        for (var n, o = [], i = 0, s = t; i < s.length; i++) {
          var u = s[i],
            l = u[0],
            p = u[1],
            c = u[2];
          ...
          var d = r[l];
          if (d.inboundNodes.length <= p) return void a(e, t);
          var h = d.inboundNodes[p];
          o.push(h.outputTensors[c])
        }
        o.length > 0 && e.apply(singletonOrArray(o), n)
      }
      ...
      for (var s = t.name, u = t.layers, l = 0, p = u; l < p.length; l++) i(h = p[l]);
      for (; !isObjectEmpty(n);)
        for (var c = 0, d = u; c < d.length; c++) {
          var h = d[c];
          if ((I = r[h.name]).name in n) {
            for (var f = 0, m = n[I.name]; f < m.length; f++) o(I, m[f]);
            delete n[I.name]
          }
        }
      for (var g = [], y = [], v = 0, b = t.inputLayers; v < b.length; v++) {
        var x = (h = b[v])[0],
          ...
          S = h[2];
        assert$1(x in r);
        var N = (I = r[x]).inboundNodes[w].outputTensors;
        g.push(N[S])
      }
      for (var T = 0, E = t.outputLayers; T < E.length; T++) {
        var I;
        x = (h = E[T])[0], w = h[1], S = h[2], assert$1(x in r), N = (I = r[x]).inboundNodes[w].outputTensors, y.push(N[S])
      }
      return new e({
        inputs: g,
        outputs: y,
  ...
  function executeInternal(e, t, r) {
    ...
    Array.isArray(s) || (s = [s]);
    for (var u = getNodeOutputs(e), l = Array.isArray(u) ? u : [u], p = 0; p < l.length; ++p) t.add(l[p], s[p]);
  ...
  function standardizeInputData(e, t, r, n, a) {
    ...
    for (var c = 0; c < t.length; ++c) 1 === (d = s[c]).shape.length && (s[c] = expandDims$1(d, 1));
    if (null != r)
      for (c = 0; c < t.length; ++c)
        if (null != r[c]) {
          var d;
          if ((d = s[c]).shape.length !== r[c].length) throw new ValueError("Error when checking " + a + ": expected " + t[c] + " to have " + r[c].length + " dimension(s). but got array with shape " + d.shape);
          for (var h = 0; h < r[c].length; ++h)
            if (0 !== h || n) {
              var f = d.shape[h],
                m = r[c][h];
              if (null != m && m >= 0 && f !== m) throw new ValueError("Error when checking " + a + ": expected " + t[c] + " to have shape [" + r[c] + "], but got array with shape [" + d.shape + "].")
            }
        } return s
  }
  ...
  function checkLossAndTargetCompatibility(e, t, r) {
    for (var n = [meanSquaredError$1, binaryCrossentropy, categoricalCrossentropy], a = 0; a < e.length; ++a) {
      ...
      if (null != i) {
        ...
        if (-1 !== n.indexOf(i))
          for (var u = o.shape.slice(1), l = s.slice(1), p = 0; p < u.length; ++p) {
            var c = u[p],
              d = l[p];
            if (null != d && c !== d) throw new ValueError("A target Tensor with shape " + o.shape + " was passed for an output of shape " + s + ", while using a loss function that expects targets to have the same shape as the output.")
          }
      }
    }
  }
  ...
  var Model = function (e) {
    ...
    return __extends$1(t, e), t.prototype.summary = function (e, t, r) {
      ...
      var c = collectMetrics(e.metrics, this.outputNames);
      nameScope("metric", function () {
        for (var e = function (e) {
            if (-1 !== p.indexOf(e)) return "continue";
            ! function (r) {
              for (var n, a, o, i = function (r) {
      ...
      if (e instanceof Tensor && (e = [e]), Array.isArray(e)) {
        ...
        for (var i = 0; i < this.inputs.length; ++i) o.add(this.inputs[i], e[i])
      } else
      ...
      return void 0 === t && (t = 32), void 0 === r && (r = !1), tidy(function () {
        ...
        for (var o = makeBatches(a, t), i = [], s = function (t) {
            var r = tidy(function () {
              var r = o[t][0],
                a = o[t][1],
                i = sliceArrays(e, r, a),
      ...
      return [e, t, null]
    }, t.prototype.fitLoop = function (e, t, r, n, a, o, i, s, u, l, p, c, d, h, f) {
      return __awaiter$1(this, void 0, void 0, function () {
        var m, g, y, v, b, x, w, S, N = this;
        return __generator$1(this, function (T) {
          switch (T.label) {
            case 0:
              if (null == n && (n = 32), null == a && (a = 1), null == l && (l = !0), null == c && (c = 0), m = !1, null != s && null != u && (m = !0), null != h && (m = !0, null == d)) throw new ValueError("Can only use `validationSteps` when doing step-wise training, i.e., `stepsPerEpoch` must be set.");
              if (null != (g = this.checkNumSamples(t, n, d, "steps_per_epoch")) && (y = range$1(0, g)), this.history = new History, v = new BaseLogger(f), i = (i = null == i ? [v] : [v].concat(i)).concat([this.history]), o > 0) throw new NotImplementedError("Verbose mode is not implemented yet.");
              return (b = new CallbackList(i)).setModel(this), b.setParams({
                epochs: a,
                initialEpoch: c,
                steps: d,
                verbose: o,
            ...
            case 1:
              T.sent(), this.stopTraining = !1, x = function (a) {
                var o, i, p, c, h;
                return __generator$1(this, function (f) {
                  switch (f.label) {
                    ...
                    case 2:
                      ...
                      l && util.shuffle(y), i = tensor1d(y), p = makeBatches(g, n), c = function (a) {
                        var l;
                        return __generator$1(this, function (c) {
                          switch (c.label) {
                            case 0:
                              return l = {}, [4, b.onBatchBegin(a, l)];
                            case 1:
                              return c.sent(), tidy(function () {
                                var c = p[a][0],
                                  d = p[a][1],
                                  h = sliceAlongFirstAxis(i, c, d - c);
                                l.batch = a, l.size = d - c;
                                for (var f = sliceArraysByIndices(t, h), g = e(f), y = 0; y < r.length; ++y) {
                                  var v = r[y],
                                    b = g[y];
                                  l[v] = b, keep(b)
                                }
                                if (a === p.length - 1 && m) {
                                  var x = N.testLoop(s, u, n);
                                  for (y = 0; y < r.length; ++y) v = r[y], b = x[y], keep(b), o["val_" + v] = b
                                }
                              }), [4, b.onBatchEnd(a, l)];
                            case 2:
                              return c.sent(), disposeTensorsInLogs(l), w.stopTraining ? [2, "break"] : [2]
                          }
                        })
                      }, h = 0, f.label = 3;
                    case 3:
                      return h < p.length ? [5, c(h)] : [3, 6];
                    case 4:
                    ...
                    case 8:
                      return f.sent(), w.stopTraining ? [2, "break"] : [2]
                  }
                })
              }, w = this, S = c, T.label = 2;
            case 2:
              return S < a ? [5, x(S)] : [3, 5];
            case 3:
      ...
      return void 0 === n && (n = 0), tidy(function () {
        ...
        for (var u = makeBatches(i, r), l = tensor1d(range$1(0, i)), p = 0; p < u.length; ++p) {
          var c = u[p][0],
            d = u[p][1],
            h = sliceAlongFirstAxis(l, c, d - c),
            f = sliceArraysByIndices(t, h),
            m = e(f);
          if (0 === p)
            for (var g = 0; g < m.length; ++g) s.push(getScalar(0));
          for (g = 0; g < m.length; ++g) {
            var y = m[g];
            s[g] = add(s[g], mul(getScalar(d - c), y))
          }
        }
        for (g = 0; g < s.length; ++g) s[g] = div(s[g], getScalar(i));
        return s
      })
      ...
      return void 0 === r && (r = {}), __awaiter$1(this, void 0, void 0, function () {
        var n, a, o, i, s, u, l, p, c, d, h, f, m, g, y, v, b, x, w, S = this;
        return __generator$1(this, function (N) {
          switch (N.label) {
            case 0:
              if (n = null == r.batchSize ? 32 : r.batchSize, a = this.standardizeUserData(e, t, !1, n), o = a[0], i = a[1], s = !1, c = !1, null != r.validationData && r.validationData.length > 0) {
                ...
                u = r.validationData[0], l = r.validationData[1], d = this.standardizeUserData(u, l, !0, n), u = d[0], l = d[1], p = u.concat(l)
              } else null != r.validationSplit && r.validationSplit > 0 && r.validationSplit < 1 ? (s = !0, h = Math.floor(o[0].shape[0] * (1 - r.validationSplit)), f = o[0].shape[0], u = sliceArrays(o, h, f), o = sliceArrays(o, 0, h), l = sliceArrays(i, h, f), i = sliceArrays(i, 0, h), c = !0, p = u.concat(l)) : null != r.validationSteps && (s = !0);
              return m = o.concat(i), this.checkTrainableWeightsConsistency(), g = function (e) {
                ...
                return [S.optimizer.minimize(function () {
                  ...
                  var o, i = new FeedDict(e),
                    s = execute(S.outputs, i, {
                      training: !0
                    });
                  ...
                  for (a = 0; a < S.metricsTensors.length; ++a) {
                    var l = S.metricsTensors[a][0],
                      p = S.metricsTensors[a][1],
                      c = mean(l(r[p], s[p]));
                    keep(c), n.push(c)
                  }
                  return o = mean(o), S.calculateLosses().forEach(function (e) {
                    o = add(o, e)
                  }), o
                }, !0, a)].concat(n)
              }, y = this.getDedupedMetricsNames(), s ? (this.makeTestFunction(), v = this.testFunction, b = y.slice().concat(y.map(function (e) {
                return "val_" + e
              }))) : (v = null, p = [], b = y.slice()), x = standardizeCallbacks(r.callbacks), [4, this.fitLoop(g, m, y, n, r.epochs, r.verbose, x, v, p, r.shuffle, b, r.initialEpoch, null, null, r.yieldEvery)];
            case 1:
              return w = N.sent(), c && (p.forEach(function (e) {
                return e.dispose()
  ...
  function loadModelInternal(e, t) {
    return void 0 === t && (t = !0), __awaiter$1(this, void 0, void 0, function () {
      ...
      return __generator$1(this, function (n) {
        if ("string" == typeof e) {
          if (0 === (r = io.getLoadHandlers(e)).length) r.push(io.browserHTTPRequest(e));
          else if (r.length > 1) throw new ValueError("Found more than one (" + r.length + ") load handlers for URL '" + e + "'");
          e = r[0]
        }
  ...
  function loadModelFromIOHandler(e, t, r) {
    return void 0 === r && (r = !0), __awaiter$1(this, void 0, void 0, function () {
      var n, a, o, i, s;
      return __generator$1(this, function (u) {
        switch (u.label) {
          case 0:
            ...
            return [4, e.load()];
          case 1:
            if (n = u.sent(), null != (a = n.modelTopology).model_config && (a = a.model_config), o = deserialize(convertPythonicToTs(a), t), null != n.weightData) {
              ...
              i = !1, s = !0, o.loadWeights(io.decodeWeights(n.weightData, n.weightSpecs), i, s, r)
            }
            return [2, o]
        }
      })
  ...
  var Sequential = function (e) {
    ...
    return __extends$1(t, e), t.prototype.add = function (e) {
      var r, n = e instanceof t || e instanceof Model;
      if (n) {
      ...
      if (0 === this.outputs.length) {
        ...
        if (n) this.outputs = r.outputs, this.inputs = r.inputs;
        else {
      ...
      var n = new e({});
      if (!(n instanceof t)) throw new ValueError("Sequential.fromConfig called on non-Sequential input: " + n);
      if (!(r instanceof Array)) throw new ValueError("Sequential.fromConfig called without an array of configs");
  ...
  var Regularizer = function (e) {
    ...
    L1L2 = function (e) {
      ...
      return __extends$1(t, e), t.prototype.apply = function (e) {
        ...
        return tidy(function () {
          var r = zeros([1]);
          return t.hasL1 && (r = add(r, sum(mul(t.l1, abs(e))))), t.hasL2 && (r = add(r, sum(mul(t.l2, square$1(e))))), r.asScalar()
        })
      }, t.prototype.getConfig = function () {
        return {
    ...
    Conv = function (e) {
      ...
      return __extends$1(t, e), t.prototype.build = function (e) {
        ...
        return tidy(function () {
          ...
          if (1 === r.rank) t = conv1dWithBias(e, r.kernel.read(), n, r.strides[0], r.padding, r.dataFormat, r.dilationRate[0]);
    ...
    return __extends$1(t, e), t.prototype.build = function (e) {
      ...
      return tidy(function () {
        ...
        var s = o[n],
          ...
          c = r.strides[0],
          d = r.strides[1],
          h = [i, deconvLength(s, c, l, r.padding), deconvLength(u, d, p, r.padding), r.filters];
  ...
  var SeparableConv = function (e) {
      ...
      return __extends$1(t, e), t.prototype.build = function (e) {
        ...
        for (var n = e[r], a = this.kernelSize.concat([n, this.depthMultiplier]), o = [], i = 0; i < this.rank; ++i) o.push(1);
  ...
  var Multiply = function (e) {
    ...
    return __extends$1(t, e), t.prototype.mergeFunction = function (e) {
      return tidy(function () {
        for (var t = ones$1(e[0].shape), r = 0, n = e; r < n.length; r++) {
          var a = n[r];
          t = mul(t, a)
        }
        return t
  ...
  function batchNormalization$1(e, t, r, n, a, o) {
    var i;
    if (void 0 === o && (o = .001), 2 === e.rank) i = batchNormalization2d(e, t, r, o, a, n);
  ...
  function broadcastNormalizeBatchInTraining(e, t, r, n, a) {
    return void 0 === a && (a = .001), tidy(function () {
      for (var o = moments(e, n), i = o.mean, s = o.variance, u = [], l = 0, p = range$1(0, e.rank); l < p.length; l++) {
        var c = p[l]; - 1 !== n.indexOf(c) ? u.push(1) : u.push(e.shape[c])
      }
      var d = i.reshape(u),
        h = s.reshape(u),
  ...
  var BatchNormalization = function (e) {
    ...
    return __extends$1(t, e), t.prototype.build = function (e) {
      ...
      return tidy(function () {
        ...
        return console.log("Type: ", n), n ? function () {
          if (c) {
        ...
        }() : normalizeBatchInTraining(a, r.gamma.read(), r.beta.read(), s, r.epsilon)[0]
      })
    }, t.prototype.getConfig = function () {
      var t = {
          axis: this.axis,
  ...
  function rnn(e, t, r, n, a, o, i, s) {
    ...
    var l, p, c = [1, 0].concat(range$1(2, u));
    if (t = transpose(t, c), null != a) throw new NotImplementedError("The rnn() function of the deeplearn.js backend does not support masking yet.");
    ...
    for (var d = r, h = t.shape[0], f = 0; f < h; ++f) {
      ...
      p = g[0], l = 0 === f ? p.reshape([1].concat(p.shape)) : concatAlongFirstAxis(l, p.reshape([1].concat(p.shape))), d = g[1]
    }
    return [p, transpose(l, [1, 0].concat(range$1(2, l.shape.length))), d]
  }
    ...
    return __extends$1(t, e), t.prototype.getStates = function () {
        ...
        if (null == t.states) Array.isArray(t.cell.stateSize) ? t.states = t.cell.stateSize.map(function (e) {
          ...
          for (var n = 0; n < t.states.length; ++n) {
            var a = e[n],
              ...
              i = [r, o];
            if (!util.arraysEqual(a.shape, i)) throw new ValueError("State " + n + " is incompatible with layer " + t.name + ": expected shape=" + i + ", received shape=" + a.shape);
            t.states[n] = a
          }
        }
      })
      ...
      return tidy(function () {
        ...
        var u = {
          ...
          }, e, o, r.goBackwards, null, null, r.unroll, s),
          p = l[0],
          c = l[1],
          d = l[2];
        if (r.stateful) throw new NotImplementedError("stateful RNN layer is not implemented yet");
        var h = r.returnSequences ? c : p;
    ...
    SimpleRNNCell = function (e) {
      ...
      return __extends$1(t, e), t.prototype.build = function (e) {
        ...
        return tidy(function () {
          ...
          var n = e[1];
          e = e[0];
          var a, o = null != t.training && t.training;
  ...
  var GRUCell = function (e) {
    ...
    return __extends$1(t, e), t.prototype.build = function (e) {
      ...
      return tidy(function () {
        ...
        var o, i, s, u = r.dropoutMask,
          l = r.recurrentDropoutMask;
        if (1 === r.implementation) {
          var p = sliceAlongLastAxis(r.kernel.read(), 0, r.units),
            c = sliceAlongLastAxis(r.kernel.read(), r.units, r.units),
            d = sliceAlongLastAxis(r.kernel.read(), 2 * r.units, r.units),
            h = sliceAlongLastAxis(r.recurrentKernel.read(), 0, r.units),
            f = sliceAlongLastAxis(r.recurrentKernel.read(), r.units, r.units),
            m = sliceAlongLastAxis(r.recurrentKernel.read(), 2 * r.units, r.units),
            g = void 0,
            y = void 0,
            v = void 0;
          0 < r.dropout && r.dropout < 1 ? (g = mul(e, u[0]), y = mul(e, u[1]), v = mul(e, u[2])) : (g = e, y = e, v = e);
          var b = dot$1(g, p),
            x = dot$1(y, c),
            w = dot$1(v, d);
          if (r.useBias) {
            var S = sliceAlongFirstAxis(r.bias.read(), 0, r.units),
              ...
              T = sliceAlongFirstAxis(r.bias.read(), 2 * r.units, r.units);
            b = biasAdd(b, S), x = biasAdd(x, N), w = biasAdd(w, T)
          }
          var E = void 0,
            I = void 0,
            A = void 0;
          0 < r.recurrentDropout && r.recurrentDropout < 1 ? (E = mul(a, l[0]), I = mul(a, l[1]), A = mul(a, l[2])) : (E = a, I = a, A = a), o = r.recurrentActivation.apply(add(b, dot$1(E, h))), i = r.recurrentActivation.apply(add(x, dot$1(I, f))), s = r.activation.apply(add(w, dot$1(mul(i, A), m)))
        } else {
          0 < r.dropout && r.dropout < 1 && (e = mul(e, u[0]));
          var _ = dot$1(e, r.kernel.read());
          r.useBias && (_ = biasAdd(_, r.bias.read())), 0 < r.dropout && r.dropout < 1 && (a = mul(a, l[0]));
          var P = dot$1(a, sliceAlongLastAxis(r.recurrentKernel.read(), 0, 2 * r.units)),
            C = (b = sliceAlongLastAxis(_, 0, r.units), x = sliceAlongLastAxis(_, r.units, r.units), sliceAlongLastAxis(P, 0, r.units)),
            k = sliceAlongLastAxis(P, r.units, r.units);
          o = r.recurrentActivation.apply(add(b, C)), i = r.recurrentActivation.apply(add(x, k)), w = sliceAlongLastAxis(_, 2 * r.units, r.units);
          var O = dot$1(mul(i, a), sliceAlongLastAxis(r.recurrentKernel.read(), 2 * r.units, r.units));
          s = r.activation.apply(add(w, O))
        }
        var R = add(mul(o, a), mul(add(getScalar(1), neg(o)), s));
        return [R, R]
      })
    }, t.prototype.getConfig = function () {
      var t = {
  ...
  var LSTMCell = function (e) {
    ...
    return __extends$1(t, e), t.prototype.build = function (e) {
      ...
      return tidy(function () {
        ...
        var i, s, u, l, p = r.dropoutMask,
          c = r.recurrentDropoutMask;
        if (1 === r.implementation) {
          var d = sliceAlongLastAxis(r.kernel.read(), 0, r.units),
            h = sliceAlongLastAxis(r.kernel.read(), r.units, r.units),
            f = sliceAlongLastAxis(r.kernel.read(), 2 * r.units, r.units),
            m = sliceAlongLastAxis(r.kernel.read(), 3 * r.units, r.units),
            g = sliceAlongLastAxis(r.recurrentKernel.read(), 0, r.units),
            y = sliceAlongLastAxis(r.recurrentKernel.read(), r.units, r.units),
            v = sliceAlongLastAxis(r.recurrentKernel.read(), 2 * r.units, r.units),
            b = sliceAlongLastAxis(r.recurrentKernel.read(), 3 * r.units, r.units),
            x = void 0,
            w = void 0,
            S = void 0,
            N = void 0;
          0 < r.dropout && r.dropout < 1 ? (x = mul(e, p[0]), w = mul(e, p[1]), S = mul(e, p[2]), N = mul(e, p[3])) : (x = e, w = e, S = e, N = e);
          var T = dot$1(x, d),
            E = dot$1(w, h),
            I = dot$1(S, f),
            A = dot$1(N, m);
          if (r.useBias) {
            var _ = sliceAlongFirstAxis(r.bias.read(), 0, r.units),
              P = sliceAlongFirstAxis(r.bias.read(), r.units, r.units),
              C = sliceAlongFirstAxis(r.bias.read(), 2 * r.units, r.units),
              k = sliceAlongFirstAxis(r.bias.read(), 3 * r.units, r.units);
            T = biasAdd(T, _), E = biasAdd(E, P), I = biasAdd(I, C), A = biasAdd(A, k)
          }
          var O = void 0,
            R = void 0,
            D = void 0,
            z = void 0;
          0 < r.recurrentDropout && r.recurrentDropout < 1 ? (O = mul(a, c[0]), R = mul(a, c[1]), D = mul(a, c[2]), z = mul(a, c[3])) : (O = a, R = a, D = a, z = a), i = r.recurrentActivation.apply(add(T, dot$1(O, g))), s = r.recurrentActivation.apply(add(E, dot$1(R, y))), u = add(mul(s, o), mul(i, r.activation.apply(add(I, dot$1(D, v))))), l = r.recurrentActivation.apply(add(A, dot$1(z, b)))
        } else {
          0 < r.dropout && r.dropout < 1 && (e = mul(e, p[0]));
          var M = dot$1(e, r.kernel.read());
          0 < r.recurrentDropout && r.recurrentDropout < 1 && (a = mul(a, c[0])), M = add(M, dot$1(a, r.recurrentKernel.read())), r.useBias && (M = biasAdd(M, r.bias.read()));
          var L = sliceAlongLastAxis(M, 0, r.units),
            V = sliceAlongLastAxis(M, r.units, r.units),
            F = sliceAlongLastAxis(M, 2 * r.units, r.units),
            B = sliceAlongLastAxis(M, 3 * r.units, r.units);
          i = r.recurrentActivation.apply(L), s = r.recurrentActivation.apply(V), u = add(mul(s, o), mul(i, r.activation.apply(F))), l = r.recurrentActivation.apply(B)
        }
        var $ = mul(l, r.activation.apply(u));
        return [$, $, u]
      })
    }, t.prototype.getConfig = function () {
      var t = {
  ...
  var StackedRNNCells = function (e) {
    ...
    return __extends$1(t, e), Object.defineProperty(t.prototype, "stateSize", {
      ...
      return tidy(function () {
        ...
        a.reverse();
        for (var u, l = [], p = 0; p < r.cells.length; ++p) s = r.cells[p], n = a[p], u = 0 === p ? [e[0]].concat(n) : [u[0]].concat(n), u = s.call(u, t), l.push(u.slice(1));
        n = [];
        for (var c = 0, d = l.slice().reverse(); c < d.length; c++) {
          var h = d[c];
          n.push.apply(n, h)
        }
        return [u[0]].concat(n)
      ...
      get: function () {
        ...
        if (!this.trainable) {
          for (var a = [], o = 0, i = this.cells; o < i.length; o++) n = i[o], a.push.apply(a, n.trainableWeights);
          return a.concat(e)
        }
        return e
      },
  ...
  function generateDropoutMask(e, t, r, n) {
    ...
    if (void 0 === r && (r = null), void 0 === n && (n = 1), n > 1) {
      for (var o = [], i = 0; i < n; i++) o.push(inTrainPhase(a, e, r));
  ...
  var Bidirectional = function (e) {
    ...
    return __extends$1(t, e), Object.defineProperty(t.prototype, "trainable", {
      ...
      for (var p = i[0] instanceof SymbolicTensor, c = 0, d = i; c < d.length; c++)
        if (d[c] instanceof SymbolicTensor !== p) throw new ValueError("The initial state of a Bidirectional layer cannot be specified as a mix of symbolic and non-symbolic tensors");
      if (p) {
        var h = [t].concat(i),
          f = this.inputSpec.concat(s),
          m = this.inputSpec;
        this.inputSpec = f;
        var g = e.prototype.apply.call(this, h, r);
      ...
      return tidy(function () {
        ...
        var n, a, o, i, s = t.initialState;
        if (null == s) n = r.forwardLayer.call(e, t), a = r.backwardLayer.call(e, t);
        else {
          var u = s.slice(0, s.length / 2),
            l = s.slice(s.length / 2);
          n = r.forwardLayer.call(e, Object.assign(t, {
            initialState: u
          })), a = r.forwardLayer.call(e, Object.assign(t, {
            initialState: l
          }))
        }
  ...
  var punycode = createCommonjsModule$1(function (e, t) {
      ! function (r) {
        ...
        function C(e, t, r) {
          var n = 0;
          for (e = r ? S(e / h) : e >> 1, e += S(e / t); e > w * c >> 1; n += l) e = S(e / w);
          return S(n + (w + 1) * e / (e + d))
        }

        function k(e) {
          var t, r, n, a, o, i, s, d, h, y, v, b = [],
            x = e.length,
            w = 0,
            N = m,
            E = f;
          for ((r = e.lastIndexOf(g)) < 0 && (r = 0), n = 0; n < r; ++n) e.charCodeAt(n) >= 128 && T("not-basic"), b.push(e.charCodeAt(n));
          for (a = r > 0 ? r + 1 : 0; a < x;) {
            for (o = w, i = 1, s = l; a >= x && T("invalid-input"), ((d = (v = e.charCodeAt(a++)) - 48 < 10 ? v - 22 : v - 65 < 26 ? v - 65 : v - 97 < 26 ? v - 97 : l) >= l || d > S((u - w) / i)) && T("overflow"), w += d * i, !(d < (h = s <= E ? p : s >= E + c ? c : s - E)); s += l) i > S(u / (y = l - h)) && T("overflow"), i *= y;
            E = C(w - o, t = b.length + 1, 0 == o), S(w / t) > u - N && T("overflow"), N += S(w / t), w %= t, b.splice(w++, 0, N)
          }
          return _(b)
        }

        function O(e) {
          var t, r, n, a, o, i, s, d, h, y, v, b, x, w, E, I = [];
          for (b = (e = A(e)).length, t = m, r = 0, o = f, i = 0; i < b; ++i)(v = e[i]) < 128 && I.push(N(v));
          for (n = a = I.length, a && I.push(g); n < b;) {
            for (s = u, i = 0; i < b; ++i)(v = e[i]) >= t && v < s && (s = v);
            for (s - t > S((u - r) / (x = n + 1)) && T("overflow"), r += (s - t) * x, t = s, i = 0; i < b; ++i)
              if ((v = e[i]) < t && ++r > u && T("overflow"), v == t) {
                for (d = r, h = l; !(d < (y = h <= o ? p : h >= o + c ? c : h - o)); h += l) E = d - y, w = l - y, I.push(N(P(y + E % w, 0))), d = S(E / w);
                I.push(N(P(d, 0))), o = C(r, x, n == a), r = 0, ++n
              }++ r, ++t
          }
          return I.join("")
        }
        if (i = {
            ...
            toUnicode: function (e) {
              return I(e, function (e) {
                return y.test(e) ? k(e.slice(4).toLowerCase()) : e
              })
            }
          }, n && a)
          if (e.exports == n) a.exports = i;
          else
  ...
  var decode = function (e, t, r, n) {
      ...
      i > 0 && s > i && (s = i);
      for (var u = 0; u < s; ++u) {
        var l, p, c, d, h = e[u].replace(o, "%20"),
          f = h.indexOf(r);
        f >= 0 ? (l = h.substr(0, f), p = h.substr(f + 1)) : (l = h, p = ""), c = decodeURIComponent(l), d = decodeURIComponent(p), hasOwnProperty(a, c) ? Array.isArray(a[c]) ? a[c].push(d) : a[c] = [a[c], d] : a[c] = d
      }
      return a
    },
  ...
  Url.prototype.parse = function (e, t, r) {
    ...
    if (i = i.trim(), !r && 1 === e.split("#").length) {
      var s = simplePathPattern.exec(i);
      if (s) return this.path = i, this.href = i, this.pathname = s[1], s[2] ? (this.search = s[2], this.query = t ? querystring.parse(this.search.substr(1)) : this.search.substr(1)) : t && (this.search = "", this.query = {}), this
    }
    var u = protocolPattern.exec(i);
    if (u) {
    ...
    if (r || u || i.match(/^\/\/[^@\/]+@[^@\/]+/)) {
      var p = "//" === i.substr(0, 2);
      !p || u && hostlessProtocol[u] || (i = i.substr(2), this.slashes = !0)
    }
    if (!hostlessProtocol[u] && (p || u && !slashedProtocol[u])) {
      for (var c, d, h = -1, f = 0; f < hostEndingChars.length; f++) - 1 !== (m = i.indexOf(hostEndingChars[f])) && (-1 === h || m < h) && (h = m);
      for (-1 !== (d = -1 === h ? i.lastIndexOf("@") : i.lastIndexOf("@", h)) && (c = i.slice(0, d), i = i.slice(d + 1), this.auth = decodeURIComponent(c)), h = -1, f = 0; f < nonHostChars.length; f++) {
        var m; - 1 !== (m = i.indexOf(nonHostChars[f])) && (-1 === h || m < h) && (h = m)
      } - 1 === h && (h = i.length), this.host = i.slice(0, h), i = i.slice(h), this.parseHost(), this.hostname = this.hostname || "";
        ...
        for (var y = this.hostname.split(/\./), v = (f = 0, y.length); f < v; f++) {
          ...
          if (b && !b.match(hostnamePartPattern)) {
            ...
            if (!x.match(hostnamePartPattern)) {
              ...
              E && (N.push(E[1]), T.unshift(E[2])), T.length && (i = "/" + T.join(".") + i), this.hostname = N.join(".");
              break
            }
          }
        }
      ...
      var I = this.port ? ":" + this.port : "",
        A = this.hostname || "";
      this.host = A + I, this.href += this.host, g && (this.hostname = this.hostname.substr(1, this.hostname.length - 2), "/" !== i[0] && (i = "/" + i))
    }
    if (!unsafeProtocol[l])
      for (f = 0, v = autoEscape.length; f < v; f++) {
        var _ = autoEscape[f];
        if (-1 !== i.indexOf(_)) {
          var P = encodeURIComponent(_);
          P === _ && (P = escape(_)), i = i.split(_).join(P)
        }
      }
    var C = i.indexOf("#"); - 1 !== C && (this.hash = i.substr(C), i = i.slice(0, C));
    var k = i.indexOf("?");
    if (-1 !== k ? (this.search = i.substr(k), this.query = i.substr(k + 1), t && (this.query = querystring.parse(this.query)), i = i.slice(0, k)) : t && (this.search = "", this.query = {}), i && (this.pathname = i), slashedProtocol[l] && this.hostname && !this.pathname && (this.pathname = "/"), this.pathname || this.search) {
      I = this.pathname || "";
      var O = this.search || "";
      this.path = I + O
    }
    ...
    return t && ":" !== t.substr(-1) && (t += ":"), this.slashes || (!t || slashedProtocol[t]) && !1 !== a ? (a = "//" + (a || ""), r && "/" !== r.charAt(0) && (r = "/" + r)) : a || (a = ""), n && "#" !== n.charAt(0) && (n = "#" + n), i && "?" !== i.charAt(0) && (i = "?" + i), t + a + (r = r.replace(/[?#]/g, function (e) {
          ...
          switch (a >>> 3) {
            ...
            case 5:
              if (n.floatVal && n.floatVal.length || (n.floatVal = []), 2 == (7 & a))
                for (var o = e.uint32() + e.pos; e.pos < o;) n.floatVal.push(e.float());
            ...
            case 17:
              if (n.uint64Val && n.uint64Val.length || (n.uint64Val = []), 2 == (7 & a))
                for (o = e.uint32() + e.pos; e.pos < o;) n.uint64Val.push(e.uint64());
            ...
            switch (a >>> 3) {
              ...
              case 3:
                if (n.i && n.i.length || (n.i = []), 2 == (7 & a))
                  for (var o = e.uint32() + e.pos; e.pos < o;) n.i.push(e.int64());
              ...
              case 6:
                if (n.type && n.type.length || (n.type = []), 2 == (7 & a))
                  for (o = e.uint32() + e.pos; e.pos < o;) n.type.push(e.int32());
  ...
  var arithmetic = [{
    ...
    OperationMapper = function () {
      function e() {
        var e = [arithmetic$1, basicMath, control$1, convolution$1, creation$1, dynamic$1, evaluation$1, logical$1, image$2, graph$1, matrices$1, normalization$1, reduction$1, sliceJoin, transformation$1],
      ...
      return Object.defineProperty(e, "Instance", {
        ...
        var t = this,
          ...
          o = e.node.reduce(function (e, o) {
            return e[o.name] = t.mapNode(o), t.isControlFlow(o) && (r = !0), t.isDynamicShape(o) && (n = !0), "Placeholder" === o.op && a.push(e[o.name]), e
          }, {}),
          i = [],
          s = [];
        return Object.keys(o).forEach(function (e) {
          ...
          t.inputNames.forEach(function (e) {
            ...
            t.inputs.push(o[r]), o[r].children.push(t)
          }), 0 === t.inputs.length && i.push(t)
        }), Object.keys(o).forEach(function (e) {
          var t = o[e];
          0 === t.children.length && s.push(t)
        }), {
          nodes: o,
          inputs: i,
          outputs: s,
    ...
    TensorArray = function () {
      ...
      return Object.defineProperty(e.prototype, "closed", {
        ...
        if (0 === this.size() && 0 === this.elementShape.length && (this.elementShape = t.shape), util.assertShapesMatch(this.elementShape, t.shape, "TensorArray " + this.name + ": Could not write to TensorArray index " + e + "."), r && r.read) throw new Error("TensorArray " + this.name + ": Could not write to TensorArray index " + e + ", because it has already been read.");
        ...
        return util.assertShapesMatch(this.elementShape, n[0].shape, "TensorArray shape mismatch: "), stack(n, 0)
        ...
        return util.assertShapesMatch(this.elementShape, n[0].shape, "TensorArray shape mismatch: tensor array shape (" + this.elementShape + ") vs first tensor shape (" + n[0].shape + ")"), concat(n, 0)
  ...
  function executeOp$2(e, t, r) {
    return __awaiter$2(this, void 0, void 0, function () {
      var n, a, o, i, s, u, l, p, c, d, h, f, m, g, y, v, b, x, w, S, N, T, E, I, A, _, P, C, k, O, R, D, z, M;
      return __generator$2(this, function (L) {
        switch (L.label) {
          ...
          case 3:
            return [2, L.sent()[0] ? [void 0, a] : [a, void 0]];
          case 4:
            return [2, (o = e.inputNames.find(function (e) {
              return void 0 !== getTensor(e, t, r)
            })) ? [getTensor(o, t, r)] : void 0];
          case 5:
            return i = getParamValue("frameName", e, t, r), s = getParamValue("tensor", e, t, r), r.enterFrame(i), [2, [s]];
          case 6:
            return u = getParamValue("tensor", e, t, r), r.exitFrame(), [2, [u]];
          case 7:
            return l = getParamValue("tensor", e, t, r), r.nextIteration(), [2, [l]];
          case 8:
            return p = getParamValue("size", e, t, r), c = getParamValue("dtype", e, t, r), d = getParamValue("elementShape", e, t, r), h = getParamValue("dynamicSize", e, t, r), f = getParamValue("clearAfterRead", e, t, r), m = getParamValue("identicalElementShapes", e, t, r), g = getParamValue("name", e, t, r), y = new TensorArray(g, c, p, d, m, h, f), r.addTensorArray(y), [2, [scalar(y.id), scalar(1)]];
          case 9:
            return v = getParamValue("tensorArrayId", e, t, r), b = getParamValue("index", e, t, r), x = getParamValue("tensor", e, t, r), r.getTensorArray(v).write(b, x), [2, [scalar(1)]];
          case 10:
            return w = getParamValue("tensorArrayId", e, t, r), S = getParamValue("index", e, t, r), [2, [r.getTensorArray(w).read(S)]];
          case 11:
            return N = getParamValue("tensorArrayId", e, t, r), T = getParamValue("indices", e, t, r), E = getParamValue("dtype", e, t, r), [2, [r.getTensorArray(N).gather(T, E)]];
          case 12:
            return I = getParamValue("tensorArrayId", e, t, r), A = getParamValue("indices", e, t, r), _ = getParamValue("tensor", e, t, r), r.getTensorArray(I).scatter(A, _), [2, [scalar(1)]];
          case 13:
            return P = getParamValue("tensorArrayId", e, t, r), C = r.getTensorArray(P), k = getParamValue("dtype", e, t, r), [2, [C.concat(k)]];
          case 14:
            return O = getParamValue("tensorArrayId", e, t, r), R = getParamValue("tensor", e, t, r), D = getParamValue("lengths", e, t, r), r.getTensorArray(O).split(D, R), [2, [scalar(1)]];
          case 15:
            return z = getParamValue("tensorArrayId", e, t, r), [2, [scalar(r.getTensorArray(z).size(), "int32")]];
          case 16:
            return M = getParamValue("tensorArrayId", e, t, r), r.getTensorArray(M).clearAndClose(), [2, []];
          case 17:
            throw TypeError("Node type " + e.op + " is not implemented")
        }
      })
  ...
  var executeOp$3 = function (e, t, r) {
    ...
    executeOp$4 = function (e, t, r) {
      switch (e.op) {
        case "fill":
          ...
          return [fill(n, getParamValue("value", e, t, r))];
        case "linspace":
          var a = getParamValue("start", e, t, r);
          return [linspace(a, getParamValue("stop", e, t, r), getParamValue("num", e, t, r))];
        case "oneHot":
          var o = getParamValue("indices", e, t, r),
            i = getParamValue("depth", e, t, r),
            s = getParamValue("onValue", e, t, r),
            u = getParamValue("offValue", e, t, r);
          return [oneHot(o, i, s, u)];
        case "ones":
        ...
        case "range":
          return [range(a = getParamValue("start", e, t, r), getParamValue("stop", e, t, r), getParamValue("step", e, t, r), getParamValue("dtype", e, t, r))];
        case "truncatedNormal":
          n = getParamValue("shape", e, t, r);
          var l = getParamValue("mean", e, t, r),
            p = getParamValue("stdDev", e, t, r),
            c = getParamValue("seed", e, t, r);
          return [truncatedNormal(n, l, p, getParamValue("dtype", e, t, r), c)];
        case "zeros":
    ...
    executeOp$12 = function (e, t, r) {
      switch (e.op) {
        ...
        case "sum":
          return n = getParamValue("axis", e, t, r), a = getParamValue("keepDims", e, t, r), [sum(getParamValue("x", e, t, r), n, a)];
        case "all":
      ...
      switch (e.op) {
        ...
        case "stridedSlice":
          ...
          var l = getParamValue("end", e, t, r),
            ...
            h = getParamValue("x", e, t, r);
          if (1 === s.length && h.shape.length > 1)
            for (var f = 1; f < h.shape.length; f++) s.push(0), l.push(h.shape[f]), p.push(p[0]);
          return [stridedSlice(h, s, l, p, c, d)];
        case "stack":
          return tidy(function () {
            var n = getParamValue("axis", e, t, r),
              a = getParamValue("tensors", e, t, r),
        ...
        case "tile":
          var m = getParamValue("reps", e, t, r);
          return [tile(getParamValue("x", e, t, r), m)];
        case "split":
          n = getParamValue("axis", e, t, r);
          var g = getParamValue("numOrSizeSplits", e, t, r);
          return split(getParamValue("x", e, t, r), g, n);
        default:
          throw TypeError("Node type " + e.op + " is not implemented")
      }
    },
    executeOp$14 = function (e, t, r) {
      switch (e.op) {
        case "cast":
        ...
        case "squeeze":
          return n = e.params.axis.value, [squeeze(getParamValue("x", e, t, r), n)];
        case "reshape":
        ...
        case "spaceToBatchND":
          var a = getParamValue("blockShape", e, t, r),
            o = split$1(getParamValue("paddings", e, t, r), 2);
          return [spaceToBatchND(getParamValue("x", e, t, r), a, o)];
        case "batchToSpaceND":
          a = getParamValue("blockShape", e, t, r);
          var i = split$1(getParamValue("crops", e, t, r), 2);
  ...
  var ExecutionContext = function () {
    ...
    GraphExecutor = function () {
      ...
      return Object.defineProperty(e.prototype, "weightMap", {
        ...
        var r = this;
        this.checkInput(e), this.checkInputShapeAndType(e);
        var n = {};
        return tidy(function () {
          var a = new ExecutionContext(r._weightMap, n),
            o = r.compiledOrder.reduce(function (e, t) {
              return e[t.name] = executeOp$15(t, e, a), e
            }, __assign$2({}, r.weightMap, e));
          return r.findOutputs(o, a, t)
        })
      }, e.prototype.executeAsync = function (e, t) {
        return __awaiter$2(this, void 0, void 0, function () {
          var r, n, a, o, i, s, u, l = this;
          return __generator$2(this, function (p) {
            switch (p.label) {
              case 0:
                return this.checkInput(e), this.checkInputShapeAndType(e), r = {}, n = new ExecutionContext(this._weightMap, r), [4, this.executeWithControlFlow(e, n)];
              case 1:
                return a = p.sent(), o = this.findOutputs(a, n, t), i = Object.keys(o).map(function (e) {
                  return o[e].id
                }), s = Object.keys(e).map(function (t) {
                  return e[t].map(function (e) {
                    return e.id
                  })
                }), u = [].concat.apply([], s), Object.keys(a).forEach(function (e) {
                  a[e].forEach(function (e) {
                    e && -1 === i.indexOf(e.id) && -1 === u.indexOf(e.id) && -1 === l.weightIds.indexOf(e.id) && e.dispose()
                  })
                }), [2, o]
            }
          })
          ...
          return __generator$2(this, function (p) {
            switch (p.label) {
              case 0:
                ...
                }), n = __assign$2({}, this.weightMap, e), a = {}, p.label = 1;
              case 1:
                return r.length > 0 ? (o = r.pop(), t.currentContext = o.contexts, i = "", "enter" === o.node.op && getParamValue("isConstant", o.node, n, t) && (i = getNodeNameAndIndex(o.node.name, t)[0]), s = executeOp$15(o.node, n, t), i || (i = getNodeNameAndIndex(o.node.name, t)[0]), u = n, l = i, [4, s]) : [3, 3];
              case 2:
                return u[l] = p.sent(), o.node.children.forEach(function (e) {
    ...
    FrozenModel = function () {
      ...
      return Object.defineProperty(e.prototype, "modelVersion", {
        ...
        return __awaiter$2(this, void 0, void 0, function () {
          ...
          return __generator$2(this, function (o) {
            switch (o.label) {
              ...
              case 1:
                return e = o.sent(), r = (t = compiled_api_1.GraphDef).decode, n = Uint8Array.bind, [4, e.arrayBuffer()];
              case 2:
        ...
        if (t = t || this.outputNodes, (e instanceof Tensor || Array.isArray(e)) && (e = this.constructTensorMap(e)), this.executor.isControlFlowModel || this.executor.isDynamicShapeModel) throw new Error("The model contains control flow or dynamic shape ops, please use executeAsync method");
